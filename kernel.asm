...
801002bd:	e8 ee 39 00 00       	call   80103cb0 <sleep>
    while(input.r == input.w){
...
801003a0:	e8 bb 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003a5:	c7 04 24 fb 78 10 80 	movl   $0x801078fb,(%esp)
...
80100519:	e8 32 40 00 00       	call   80104550 <memmove>
    memset(crt+pos, 0, sizeof(crt[0])*(24*80 - pos));
...
8010052e:	e8 6d 3f 00 00       	call   801044a0 <memset>
...
801005a9:	0f b6 92 f0 6f 10 80 	movzbl -0x7fef9010(%edx),%edx
  }while((x /= base) != 0);
...
80100705:	e8 46 3d 00 00       	call   80104450 <release>
...
801007a8:	e8 f3 3b 00 00       	call   801043a0 <acquire>
...
801007b8:	b8 28 00 00 00       	mov    $0x28,%eax
        s = "(null)";
801007bd:	bf d8 6f 10 80       	mov    $0x80106fd8,%edi
801007c2:	eb bc                	jmp    80100780 <cprintf+0x120>
    panic("null fmt");
801007c4:	83 ec 0c             	sub    $0xc,%esp
801007c7:	68 df 6f 10 80       	push   $0x80106fdf
...
801007f3:	e8 a8 3b 00 00       	call   801043a0 <acquire>
  while((c = getc()) >= 0){
...
80100858:	e8 f3 3b 00 00       	call   80104450 <release>
  if(doprocdump) {
...
801008e6:	e8 85 35 00 00       	call   80103e70 <wakeup>
...
80100967:	e9 f4 35 00 00       	jmp    80103f60 <procdump>
        input.buf[input.e++ % INPUT_BUF] = c;
...
80100996:	68 e8 6f 10 80       	push   $0x80106fe8
8010099b:	68 20 a5 10 80       	push   $0x8010a520
801009a0:	e8 9b 38 00 00       	call   80104240 <initlock>
...
801009ec:	e8 bf 2d 00 00       	call   801037b0 <myproc>
...
80100a62:	75 d2                	jne    80100a36 <exec+0x56>
  if((pgdir = setupkvm()) == 0)
80100a64:	e8 77 62 00 00       	call   80106ce0 <setupkvm>
...
80100af4:	e8 47 60 00 00       	call   80106b40 <allocuvm>
...
80100b2a:	e8 51 5f 00 00       	call   80106a80 <loaduvm>
...
80100b49:	e8 12 61 00 00       	call   80106c60 <freevm>
...
80100b85:	e8 b6 5f 00 00       	call   80106b40 <allocuvm>
...
80100b9c:	e8 bf 60 00 00       	call   80106c60 <freevm>
...
80100bb6:	68 01 70 10 80       	push   $0x80107001
...
80100be1:	e8 9a 61 00 00       	call   80106d80 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
80100c1d:	e8 9e 3a 00 00       	call   801046c0 <strlen>
...
80100c30:	e8 8b 3a 00 00       	call   801046c0 <strlen>
...
80100c41:	e8 9a 62 00 00       	call   80106ee0 <copyout>
...
80100ca5:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100cab:	e8 30 62 00 00       	call   80106ee0 <copyout>
...
80100cf0:	e8 8b 39 00 00       	call   80104680 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100d1c:	e8 cf 5b 00 00       	call   801068f0 <switchuvm>
  freevm(oldpgdir);
80100d21:	89 3c 24             	mov    %edi,(%esp)
80100d24:	e8 37 5f 00 00       	call   80106c60 <freevm>
  return 0;
...
80100d46:	68 0d 70 10 80       	push   $0x8010700d
...
80100d71:	e8 2a 36 00 00       	call   801043a0 <acquire>
...
80100da1:	e8 aa 36 00 00       	call   80104450 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100dba:	e8 91 36 00 00       	call   80104450 <release>
}
...
80100ddf:	e8 bc 35 00 00       	call   801043a0 <acquire>
  if(f->ref < 1)
...
80100dfc:	e8 4f 36 00 00       	call   80104450 <release>
  return f;
}
...
80100e0b:	68 14 70 10 80       	push   $0x80107014
...
80100e31:	e8 6a 35 00 00       	call   801043a0 <acquire>
  if(f->ref < 1)
...
80100e5b:	5d                   	pop    %ebp
    release(&ftable.lock);
80100e5c:	e9 ef 35 00 00       	jmp    80104450 <release>
...
80100e85:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100e88:	e8 c3 35 00 00       	call   80104450 <release>
  if(ff.type == FD_PIPE)
...
80100ee2:	68 1c 70 10 80       	push   $0x8010701c
...
80100fc2:	68 26 70 10 80       	push   $0x80107026
...
801010e0:	68 2f 70 10 80       	push   $0x8010702f
801010e5:	e8 86 f2 ff ff       	call   80100370 <panic>
  panic("filewrite");
801010ea:	83 ec 0c             	sub    $0xc,%esp
801010ed:	68 35 70 10 80       	push   $0x80107035
...
801011a4:	68 3f 70 10 80       	push   $0x8010703f
...
801013a5:	68 65 70 10 80       	push   $0x80107065
...
80101464:	68 78 70 10 80       	push   $0x80107078
...
8010157e:	e8 1d 2f 00 00       	call   801044a0 <memset>
      dip->type = type;
...
80101621:	e8 2a 2f 00 00       	call   80104550 <memmove>
  log_write(bp);
...
8010165f:	e8 ec 2d 00 00       	call   80104450 <release>
}
...
80101692:	e8 b9 2a 00 00       	call   80104150 <acquiresleep>
  if(ip->valid == 0){
...
80101708:	e8 43 2e 00 00       	call   80104550 <memmove>
    brelse(bp);
...
80101763:	e8 88 2a 00 00       	call   801041f0 <holdingsleep>
...
8010177e:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
8010177f:	e9 2c 2a 00 00       	jmp    801041b0 <releasesleep>
    panic("iunlock");
...
801017b0:	e8 9b 29 00 00       	call   80104150 <acquiresleep>
...
801017ca:	e8 e1 29 00 00       	call   801041b0 <releasesleep>
  acquire(&icache.lock);
...
801017ef:	5d                   	pop    %ebp
  release(&icache.lock);
801017f0:	e9 5b 2c 00 00       	jmp    80104450 <release>
...
8010180f:	e8 3c 2c 00 00       	call   80104450 <release>
    if(r == 1){
...
801019f5:	01 de                	add    %ebx,%esi
    memmove(dst, bp->data + off%BSIZE, m);
801019f7:	e8 54 2b 00 00       	call   80104550 <memmove>
    brelse(bp);
...
80101af3:	e8 58 2a 00 00       	call   80104550 <memmove>
    log_write(bp);
...
80101b8e:	e8 2d 2a 00 00       	call   801045c0 <strncmp>
}
80101b93:	c9                   	leave  
80101b94:	c3                   	ret    
...
80101bf5:	e8 c6 29 00 00       	call   801045c0 <strncmp>
      continue;
...
80101c89:	e8 c2 27 00 00       	call   80104450 <release>
...
80101ce5:	e8 66 28 00 00       	call   80104550 <memmove>
    path++;
...
80101d74:	e8 d7 27 00 00       	call   80104550 <memmove>
    name[len] = 0;
...
80101ea8:	68 e2 76 10 80       	push   $0x801076e2
...
8010208e:	e8 dd 1d 00 00       	call   80103e70 <wakeup>
...
801020ac:	e8 9f 23 00 00       	call   80104450 <release>
...
801020fe:	e8 ed 20 00 00       	call   801041f0 <holdingsleep>
...
80102189:	e8 22 1b 00 00       	call   80103cb0 <sleep>
  while((b->flags & (B_VALID|B_DIRTY)) != B_VALID){
...
801021a5:	c9                   	leave  
  release(&idelock);
801021a6:	e9 a5 22 00 00       	jmp    80104450 <release>
  for(pp=&idequeue; *pp; pp=&(*pp)->qnext)  //DOC:insert-queue
...
80102312:	e8 89 21 00 00       	call   801044a0 <memset>
...
8010234a:	c9                   	leave  
    release(&kmem.lock);
8010234b:	e9 00 21 00 00       	jmp    80104450 <release>
    acquire(&kmem.lock);
...
801024be:	e8 8d 1f 00 00       	call   80104450 <release>
...
8010253f:	0f b6 8a 20 73 10 80 	movzbl -0x7fef8ce0(%edx),%ecx
  shift ^= togglecode[data];
80102546:	0f b6 82 20 72 10 80 	movzbl -0x7fef8de0(%edx),%eax
  shift |= shiftcode[data];
...
8010255c:	83 e1 08             	and    $0x8,%ecx
  c = charcode[shift & (CTL | SHIFT)][data];
8010255f:	8b 04 85 00 72 10 80 	mov    -0x7fef8e00(,%eax,4),%eax
...
8010258c:	0f 44 d0             	cmove  %eax,%edx
    shift &= ~(shiftcode[data] | E0ESC);
8010258f:	0f b6 82 20 73 10 80 	movzbl -0x7fef8ce0(%edx),%eax
...
80102907:	e8 e4 1b 00 00       	call   801044f0 <memcmp>
...
80102a34:	e8 17 1b 00 00       	call   80104550 <memmove>
...
80102ada:	68 20 74 10 80       	push   $0x80107420
80102adf:	68 80 26 11 80       	push   $0x80112680
80102ae4:	e8 57 17 00 00       	call   80104240 <initlock>
  readsb(dev, &sb);
80102ae9:	58                   	pop    %eax
...
80102b7b:	e8 20 18 00 00       	call   801043a0 <acquire>
...
80102b95:	e8 16 11 00 00       	call   80103cb0 <sleep>
...
80102bcc:	e8 7f 18 00 00       	call   80104450 <release>
      break;
    }
  }
}
...
80102bee:	e8 ad 17 00 00       	call   801043a0 <acquire>
  log.outstanding -= 1;
...
80102c8c:	e8 bf 18 00 00       	call   80104550 <memmove>
...
80102cd5:	e8 c6 16 00 00       	call   801043a0 <acquire>
    wakeup(&log);
...
80102ce8:	00 00 00 
    wakeup(&log);
80102ceb:	e8 80 11 00 00       	call   80103e70 <wakeup>
    release(&log.lock);
80102cf0:	c7 04 24 80 26 11 80 	movl   $0x80112680,(%esp)
80102cf7:	e8 54 17 00 00       	call   80104450 <release>
...
80102d18:	e8 53 11 00 00       	call   80103e70 <wakeup>
  release(&log.lock);
80102d1d:	c7 04 24 80 26 11 80 	movl   $0x80112680,(%esp)
80102d24:	e8 27 17 00 00       	call   80104450 <release>
...
80102d37:	68 24 74 10 80       	push   $0x80107424
...
80102d8e:	e8 0d 16 00 00       	call   801043a0 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102ddc:	c9                   	leave  
  release(&log.lock);
80102ddd:	e9 6e 16 00 00       	jmp    80104450 <release>
...
80102e03:	68 33 74 10 80       	push   $0x80107433
80102e08:	e8 63 d5 ff ff       	call   80100370 <panic>
    panic("log_write outside of trans");
80102e0d:	83 ec 0c             	sub    $0xc,%esp
80102e10:	68 49 74 10 80       	push   $0x80107449
...
80102e38:	68 64 74 10 80       	push   $0x80107464
80102e3d:	e8 1e d8 ff ff       	call   80100660 <cprintf>
  idtinit();       // load idt register
80102e42:	e8 69 29 00 00       	call   801057b0 <idtinit>
...
80102e5a:	e8 d1 11 00 00       	call   80104030 <scheduler>
80102e5f:	90                   	nop
...
80102e63:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102e66:	e8 65 3a 00 00       	call   801068d0 <switchkvm>
  seginit();
80102e6b:	e8 60 39 00 00       	call   801067d0 <seginit>
  lapicinit();
...
80102ec9:	e8 d2 2b 00 00       	call   80105aa0 <uartinit>
  pinit();         // process table
80102ece:	e8 1d 08 00 00       	call   801036f0 <pinit>
  tvinit();        // trap vectors
80102ed3:	e8 38 28 00 00       	call   80105710 <tvinit>
  binit();         // buffer cache
...
80102ef9:	e8 52 16 00 00       	call   80104550 <memmove>
  for(c = cpus; c < cpus+ncpu; c++){
...
80102fc8:	68 78 74 10 80       	push   $0x80107478
80102fcd:	56                   	push   %esi
80102fce:	e8 1d 15 00 00       	call   801044f0 <memcmp>
...
8010307c:	68 95 74 10 80       	push   $0x80107495
80103081:	56                   	push   %esi
80103082:	e8 69 14 00 00       	call   801044f0 <memcmp>
...
80103110:	ff 24 95 bc 74 10 80 	jmp    *-0x7fef8b44(,%edx,4)
...
801031b7:	68 7d 74 10 80       	push   $0x8010747d
801031bc:	e8 af d1 ff ff       	call   80100370 <panic>
    panic("Didn't find a suitable machine");
801031c1:	83 ec 0c             	sub    $0xc,%esp
801031c4:	68 9c 74 10 80       	push   $0x8010749c
...
80103270:	00 00 00 
  initlock(&p->lock, "pipe");
80103273:	68 d0 74 10 80       	push   $0x801074d0
80103278:	50                   	push   %eax
80103279:	e8 c2 0f 00 00       	call   80104240 <initlock>
  (*f0)->type = FD_PIPE;
...
8010330f:	e8 8c 10 00 00       	call   801043a0 <acquire>
  if(writable){
...
8010332f:	e8 3c 0b 00 00       	call   80103e70 <wakeup>
...
80103353:	5d                   	pop    %ebp
    release(&p->lock);
80103354:	e9 f7 10 00 00       	jmp    80104450 <release>
...
80103374:	e8 f7 0a 00 00       	call   80103e70 <wakeup>
...
80103384:	e8 c7 10 00 00       	call   80104450 <release>
    kfree((char*)p);
...
801033ad:	e8 ee 0f 00 00       	call   801043a0 <acquire>
  for(i = 0; i < n; i++){
...
80103404:	e8 67 0a 00 00       	call   80103e70 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
80103409:	5a                   	pop    %edx
8010340a:	59                   	pop    %ecx
8010340b:	53                   	push   %ebx
8010340c:	56                   	push   %esi
8010340d:	e8 9e 08 00 00       	call   80103cb0 <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
...
80103434:	e8 77 03 00 00       	call   801037b0 <myproc>
...
80103444:	e8 07 10 00 00       	call   80104450 <release>
        return -1;
...
80103494:	e8 d7 09 00 00       	call   80103e70 <wakeup>
  release(&p->lock);
80103499:	89 1c 24             	mov    %ebx,(%esp)
8010349c:	e8 af 0f 00 00       	call   80104450 <release>
  return n;
...
801034c0:	e8 db 0e 00 00       	call   801043a0 <acquire>
...
801034f5:	e8 b6 07 00 00       	call   80103cb0 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
...
8010352e:	e8 1d 0f 00 00       	call   80104450 <release>
      return -1;
...
80103587:	e8 e4 08 00 00       	call   80103e70 <wakeup>
  release(&p->lock);
8010358c:	89 34 24             	mov    %esi,(%esp)
8010358f:	e8 bc 0e 00 00       	call   80104450 <release>
  return i;
...
801035dc:	0f 83 8e 00 00 00    	jae    80103670 <allocproc+0xc0>
    if(p->state == UNUSED)
...
801035f1:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
  p->tickets = 50;
801035f8:	c7 43 7c 32 00 00 00 	movl   $0x32,0x7c(%ebx)
  p->passada = 0;
801035ff:	c7 83 84 00 00 00 00 	movl   $0x0,0x84(%ebx)
80103606:	00 00 00 
  p->pid = nextpid++;
80103609:	8d 50 01             	lea    0x1(%eax),%edx
8010360c:	89 43 10             	mov    %eax,0x10(%ebx)
  release(&ptable.lock);
8010360f:	68 20 2d 11 80       	push   $0x80112d20
  p->pid = nextpid++;
80103614:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
8010361a:	e8 31 0e 00 00       	call   80104450 <release>
...
8010362c:	74 5b                	je     80103689 <allocproc+0xd9>
    return 0;
  }
...
8010363c:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010363f:	c7 40 14 ff 56 10 80 	movl   $0x801056ff,0x14(%eax)
  p->context = (struct context*)sp;
...
8010364e:	e8 4d 0e 00 00       	call   801044a0 <memset>
...
80103656:	83 c4 10             	add    $0x10,%esp
  p->context->eip = (uint)forkret;
80103659:	c7 40 10 a0 36 10 80 	movl   $0x801036a0,0x10(%eax)
}
...
8010367a:	e8 d1 0d 00 00       	call   80104450 <release>
}
...
80103692:	eb cc                	jmp    80103660 <allocproc+0xb0>
...
801036ab:	e8 a0 0d 00 00       	call   80104450 <release>
...
801036f6:	68 d5 74 10 80       	push   $0x801074d5
801036fb:	68 20 2d 11 80       	push   $0x80112d20
80103700:	e8 3b 0b 00 00       	call   80104240 <initlock>
}
...
80103745:	74 26                	je     8010376d <mycpu+0x5d>
    if (cpus[i].apicid == apicid)
...
8010375a:	05 80 27 11 80       	add    $0x80112780,%eax
}
...
80103765:	c3                   	ret    
    if (cpus[i].apicid == apicid)
80103766:	b8 80 27 11 80       	mov    $0x80112780,%eax
      return &cpus[i];
8010376b:	eb f2                	jmp    8010375f <mycpu+0x4f>
  panic("unknown apicid\n");
8010376d:	83 ec 0c             	sub    $0xc,%esp
80103770:	68 dc 74 10 80       	push   $0x801074dc
80103775:	e8 f6 cb ff ff       	call   80100370 <panic>
    panic("mycpu called with interrupts enabled\n");
8010377a:	83 ec 0c             	sub    $0xc,%esp
8010377d:	68 b8 75 10 80       	push   $0x801075b8
...
801037b4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801037b7:	e8 04 0b 00 00       	call   801042c0 <pushcli>
  c = mycpu();
801037bc:	e8 4f ff ff ff       	call   80103710 <mycpu>
  p = c->proc;
801037c1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801037c7:	e8 34 0b 00 00       	call   80104300 <popcli>
}
...
801037f3:	e8 e8 34 00 00       	call   80106ce0 <setupkvm>
...
80103811:	e8 ea 31 00 00       	call   80106a00 <inituvm>
...
80103826:	e8 75 0c 00 00       	call   801044a0 <memset>
...
8010387f:	68 05 75 10 80       	push   $0x80107505
80103884:	50                   	push   %eax
80103885:	e8 f6 0d 00 00       	call   80104680 <safestrcpy>
  p->cwd = namei("/");
8010388a:	c7 04 24 0e 75 10 80 	movl   $0x8010750e,(%esp)
...
801038b3:	e8 98 0b 00 00       	call   80104450 <release>
}
...
801038c3:	68 ec 74 10 80       	push   $0x801074ec
...
801038d5:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
801038d8:	e8 e3 09 00 00       	call   801042c0 <pushcli>
  c = mycpu();
801038dd:	e8 2e fe ff ff       	call   80103710 <mycpu>
  p = c->proc;
801038e2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801038e8:	e8 13 0a 00 00       	call   80104300 <popcli>
  if(n > 0){
...
801038fe:	e8 3d 32 00 00       	call   80106b40 <allocuvm>
...
80103910:	e8 db 2f 00 00       	call   801068f0 <switchuvm>
  return 0;
...
80103934:	e8 f7 32 00 00       	call   80106c30 <deallocuvm>
...
80103956:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103959:	e8 62 09 00 00       	call   801042c0 <pushcli>
  c = mycpu();
8010395e:	e8 ad fd ff ff       	call   80103710 <mycpu>
  p = c->proc;
80103963:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103969:	e8 92 09 00 00       	call   80104300 <popcli>
  if((np = allocproc()) == 0){
8010396e:	e8 3d fc ff ff       	call   801035b0 <allocproc>
...
80103988:	e8 23 34 00 00       	call   80106db0 <copyuvm>
...
801039cc:	e8 ff d3 ff ff       	call   80100dd0 <filedup>
...
801039e9:	83 c3 6c             	add    $0x6c,%ebx
  np->cwd = idup(curproc->cwd);
801039ec:	e8 4f dc ff ff       	call   80101640 <idup>
...
80103a3f:	83 ec 0c             	sub    $0xc,%esp
    return -1;
80103a42:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
    kfree(np->kstack);
80103a47:	ff 77 08             	pushl  0x8(%edi)
80103a4a:	e8 91 e8 ff ff       	call   801022e0 <kfree>
    np->kstack = 0;
80103a4f:	c7 47 08 00 00 00 00 	movl   $0x0,0x8(%edi)
    np->state = UNUSED;
80103a56:	c7 47 0c 00 00 00 00 	movl   $0x0,0xc(%edi)
    return -1;
...
80103a74:	53                   	push   %ebx
  pushcli();
80103a75:	e8 46 08 00 00       	call   801042c0 <pushcli>
  c = mycpu();
80103a7a:	e8 91 fc ff ff       	call   80103710 <mycpu>
  p = c->proc;
80103a7f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103a85:	e8 76 08 00 00       	call   80104300 <popcli>
  if(!holding(&ptable.lock))
80103a8a:	83 ec 0c             	sub    $0xc,%esp
80103a8d:	68 20 2d 11 80       	push   $0x80112d20
80103a92:	e8 d9 08 00 00       	call   80104370 <holding>
80103a97:	83 c4 10             	add    $0x10,%esp
80103a9a:	85 c0                	test   %eax,%eax
80103a9c:	74 4f                	je     80103aed <sched+0x7d>
  if(mycpu()->ncli != 1)
80103a9e:	e8 6d fc ff ff       	call   80103710 <mycpu>
80103aa3:	83 b8 a4 00 00 00 01 	cmpl   $0x1,0xa4(%eax)
80103aaa:	75 68                	jne    80103b14 <sched+0xa4>
  if(p->state == RUNNING)
80103aac:	83 7b 0c 04          	cmpl   $0x4,0xc(%ebx)
80103ab0:	74 55                	je     80103b07 <sched+0x97>
80103ab2:	9c                   	pushf  
80103ab3:	58                   	pop    %eax
  if(readeflags()&FL_IF)
80103ab4:	f6 c4 02             	test   $0x2,%ah
80103ab7:	75 41                	jne    80103afa <sched+0x8a>
  intena = mycpu()->intena;
80103ab9:	e8 52 fc ff ff       	call   80103710 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103abe:	83 c3 1c             	add    $0x1c,%ebx
  intena = mycpu()->intena;
80103ac1:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103ac7:	e8 44 fc ff ff       	call   80103710 <mycpu>
80103acc:	83 ec 08             	sub    $0x8,%esp
80103acf:	ff 70 04             	pushl  0x4(%eax)
80103ad2:	53                   	push   %ebx
80103ad3:	e8 03 0c 00 00       	call   801046db <swtch>
  mycpu()->intena = intena;
80103ad8:	e8 33 fc ff ff       	call   80103710 <mycpu>
}
80103add:	83 c4 10             	add    $0x10,%esp
  mycpu()->intena = intena;
80103ae0:	89 b0 a8 00 00 00    	mov    %esi,0xa8(%eax)
}
...
80103af0:	68 10 75 10 80       	push   $0x80107510
80103af5:	e8 76 c8 ff ff       	call   80100370 <panic>
    panic("sched interruptible");
80103afa:	83 ec 0c             	sub    $0xc,%esp
80103afd:	68 3c 75 10 80       	push   $0x8010753c
80103b02:	e8 69 c8 ff ff       	call   80100370 <panic>
    panic("sched running");
80103b07:	83 ec 0c             	sub    $0xc,%esp
80103b0a:	68 2e 75 10 80       	push   $0x8010752e
80103b0f:	e8 5c c8 ff ff       	call   80100370 <panic>
    panic("sched locks");
80103b14:	83 ec 0c             	sub    $0xc,%esp
80103b17:	68 22 75 10 80       	push   $0x80107522
80103b1c:	e8 4f c8 ff ff       	call   80100370 <panic>
80103b21:	eb 0d                	jmp    80103b30 <exit>
80103b23:	90                   	nop
80103b24:	90                   	nop
80103b25:	90                   	nop
80103b26:	90                   	nop
...
80103b36:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103b39:	e8 82 07 00 00       	call   801042c0 <pushcli>
  c = mycpu();
80103b3e:	e8 cd fb ff ff       	call   80103710 <mycpu>
  p = c->proc;
80103b43:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103b49:	e8 b2 07 00 00       	call   80104300 <popcli>
  if(curproc == initproc)
80103b4e:	39 35 b8 a5 10 80    	cmp    %esi,0x8010a5b8
80103b54:	8d 5e 28             	lea    0x28(%esi),%ebx
80103b57:	8d 7e 68             	lea    0x68(%esi),%edi
80103b5a:	0f 84 f1 00 00 00    	je     80103c51 <exit+0x121>
    if(curproc->ofile[fd]){
80103b60:	8b 03                	mov    (%ebx),%eax
80103b62:	85 c0                	test   %eax,%eax
80103b64:	74 12                	je     80103b78 <exit+0x48>
...
80103b78:	83 c3 04             	add    $0x4,%ebx
  for(fd = 0; fd < NOFILE; fd++){
80103b7b:	39 fb                	cmp    %edi,%ebx
80103b7d:	75 e1                	jne    80103b60 <exit+0x30>
  begin_op();
80103b7f:	e8 ec ef ff ff       	call   80102b70 <begin_op>
  iput(curproc->cwd);
80103b84:	83 ec 0c             	sub    $0xc,%esp
80103b87:	ff 76 68             	pushl  0x68(%esi)
80103b8a:	e8 11 dc ff ff       	call   801017a0 <iput>
  end_op();
80103b8f:	e8 4c f0 ff ff       	call   80102be0 <end_op>
  curproc->cwd = 0;
80103b94:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
  acquire(&ptable.lock);
80103b9b:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103ba2:	e8 f9 07 00 00       	call   801043a0 <acquire>
  wakeup1(curproc->parent);
80103ba7:	8b 56 14             	mov    0x14(%esi),%edx
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103bad:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103bb2:	eb 10                	jmp    80103bc4 <exit+0x94>
80103bb4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103bb8:	05 88 00 00 00       	add    $0x88,%eax
80103bbd:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
80103bc2:	73 1e                	jae    80103be2 <exit+0xb2>
    if(p->state == SLEEPING && p->chan == chan)
80103bc4:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80103bc8:	75 ee                	jne    80103bb8 <exit+0x88>
80103bca:	3b 50 20             	cmp    0x20(%eax),%edx
80103bcd:	75 e9                	jne    80103bb8 <exit+0x88>
      p->state = RUNNABLE;
80103bcf:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103bd6:	05 88 00 00 00       	add    $0x88,%eax
80103bdb:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
80103be0:	72 e2                	jb     80103bc4 <exit+0x94>
      p->parent = initproc;
80103be2:	8b 0d b8 a5 10 80    	mov    0x8010a5b8,%ecx
80103be8:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
80103bed:	eb 0f                	jmp    80103bfe <exit+0xce>
80103bef:	90                   	nop
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103bf0:	81 c2 88 00 00 00    	add    $0x88,%edx
80103bf6:	81 fa 54 4f 11 80    	cmp    $0x80114f54,%edx
80103bfc:	73 3a                	jae    80103c38 <exit+0x108>
    if(p->parent == curproc){
80103bfe:	39 72 14             	cmp    %esi,0x14(%edx)
80103c01:	75 ed                	jne    80103bf0 <exit+0xc0>
      if(p->state == ZOMBIE)
80103c03:	83 7a 0c 05          	cmpl   $0x5,0xc(%edx)
      p->parent = initproc;
80103c07:	89 4a 14             	mov    %ecx,0x14(%edx)
      if(p->state == ZOMBIE)
80103c0a:	75 e4                	jne    80103bf0 <exit+0xc0>
80103c0c:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103c11:	eb 11                	jmp    80103c24 <exit+0xf4>
80103c13:	90                   	nop
80103c14:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103c18:	05 88 00 00 00       	add    $0x88,%eax
80103c1d:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
80103c22:	73 cc                	jae    80103bf0 <exit+0xc0>
    if(p->state == SLEEPING && p->chan == chan)
80103c24:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80103c28:	75 ee                	jne    80103c18 <exit+0xe8>
80103c2a:	3b 48 20             	cmp    0x20(%eax),%ecx
80103c2d:	75 e9                	jne    80103c18 <exit+0xe8>
      p->state = RUNNABLE;
80103c2f:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
80103c36:	eb e0                	jmp    80103c18 <exit+0xe8>
  curproc->state = ZOMBIE;
80103c38:	c7 46 0c 05 00 00 00 	movl   $0x5,0xc(%esi)
  sched();
80103c3f:	e8 2c fe ff ff       	call   80103a70 <sched>
  panic("zombie exit");
80103c44:	83 ec 0c             	sub    $0xc,%esp
80103c47:	68 5d 75 10 80       	push   $0x8010755d
80103c4c:	e8 1f c7 ff ff       	call   80100370 <panic>
    panic("init exiting");
80103c51:	83 ec 0c             	sub    $0xc,%esp
80103c54:	68 50 75 10 80       	push   $0x80107550
...
80103c6c:	e8 2f 07 00 00       	call   801043a0 <acquire>
  pushcli();
80103c71:	e8 4a 06 00 00       	call   801042c0 <pushcli>
  c = mycpu();
80103c76:	e8 95 fa ff ff       	call   80103710 <mycpu>
  p = c->proc;
80103c7b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103c81:	e8 7a 06 00 00       	call   80104300 <popcli>
  myproc()->state = RUNNABLE;
80103c86:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  sched();
80103c8d:	e8 de fd ff ff       	call   80103a70 <sched>
  release(&ptable.lock);
...
80103cbc:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103cbf:	e8 fc 05 00 00       	call   801042c0 <pushcli>
  c = mycpu();
80103cc4:	e8 47 fa ff ff       	call   80103710 <mycpu>
  p = c->proc;
80103cc9:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ccf:	e8 2c 06 00 00       	call   80104300 <popcli>
  if(p == 0)
80103cd4:	85 db                	test   %ebx,%ebx
80103cd6:	0f 84 87 00 00 00    	je     80103d63 <sleep+0xb3>
  if(lk == 0)
80103cdc:	85 f6                	test   %esi,%esi
80103cde:	74 76                	je     80103d56 <sleep+0xa6>
  if(lk != &ptable.lock){  //DOC: sleeplock0
80103ce0:	81 fe 20 2d 11 80    	cmp    $0x80112d20,%esi
80103ce6:	74 50                	je     80103d38 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80103ce8:	83 ec 0c             	sub    $0xc,%esp
80103ceb:	68 20 2d 11 80       	push   $0x80112d20
80103cf0:	e8 ab 06 00 00       	call   801043a0 <acquire>
    release(lk);
80103cf5:	89 34 24             	mov    %esi,(%esp)
80103cf8:	e8 53 07 00 00       	call   80104450 <release>
  p->chan = chan;
80103cfd:	89 7b 20             	mov    %edi,0x20(%ebx)
  p->state = SLEEPING;
80103d00:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80103d07:	e8 64 fd ff ff       	call   80103a70 <sched>
  p->chan = 0;
80103d0c:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
80103d13:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103d1a:	e8 31 07 00 00       	call   80104450 <release>
    acquire(lk);
80103d1f:	89 75 08             	mov    %esi,0x8(%ebp)
80103d22:	83 c4 10             	add    $0x10,%esp
}
80103d25:	8d 65 f4             	lea    -0xc(%ebp),%esp
80103d28:	5b                   	pop    %ebx
80103d29:	5e                   	pop    %esi
80103d2a:	5f                   	pop    %edi
80103d2b:	5d                   	pop    %ebp
    acquire(lk);
80103d2c:	e9 6f 06 00 00       	jmp    801043a0 <acquire>
80103d31:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  p->chan = chan;
80103d38:	89 7b 20             	mov    %edi,0x20(%ebx)
  p->state = SLEEPING;
80103d3b:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80103d42:	e8 29 fd ff ff       	call   80103a70 <sched>
  p->chan = 0;
80103d47:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
}
80103d4e:	8d 65 f4             	lea    -0xc(%ebp),%esp
80103d51:	5b                   	pop    %ebx
80103d52:	5e                   	pop    %esi
80103d53:	5f                   	pop    %edi
80103d54:	5d                   	pop    %ebp
...
80103d59:	68 6f 75 10 80       	push   $0x8010756f
80103d5e:	e8 0d c6 ff ff       	call   80100370 <panic>
    panic("sleep");
80103d63:	83 ec 0c             	sub    $0xc,%esp
80103d66:	68 69 75 10 80       	push   $0x80107569
80103d6b:	e8 00 c6 ff ff       	call   80100370 <panic>
...
80103d74:	53                   	push   %ebx
  pushcli();
80103d75:	e8 46 05 00 00       	call   801042c0 <pushcli>
  c = mycpu();
80103d7a:	e8 91 f9 ff ff       	call   80103710 <mycpu>
  p = c->proc;
80103d7f:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103d85:	e8 76 05 00 00       	call   80104300 <popcli>
  acquire(&ptable.lock);
80103d8a:	83 ec 0c             	sub    $0xc,%esp
80103d8d:	68 20 2d 11 80       	push   $0x80112d20
80103d92:	e8 09 06 00 00       	call   801043a0 <acquire>
80103d97:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
80103d9a:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103d9c:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
80103da1:	eb 13                	jmp    80103db6 <wait+0x46>
80103da3:	90                   	nop
80103da4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103da8:	81 c3 88 00 00 00    	add    $0x88,%ebx
80103dae:	81 fb 54 4f 11 80    	cmp    $0x80114f54,%ebx
80103db4:	73 22                	jae    80103dd8 <wait+0x68>
      if(p->parent != curproc)
80103db6:	39 73 14             	cmp    %esi,0x14(%ebx)
80103db9:	75 ed                	jne    80103da8 <wait+0x38>
      if(p->state == ZOMBIE){
80103dbb:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
80103dbf:	74 35                	je     80103df6 <wait+0x86>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103dc1:	81 c3 88 00 00 00    	add    $0x88,%ebx
      havekids = 1;
80103dc7:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103dcc:	81 fb 54 4f 11 80    	cmp    $0x80114f54,%ebx
80103dd2:	72 e2                	jb     80103db6 <wait+0x46>
80103dd4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(!havekids || curproc->killed){
80103dd8:	85 c0                	test   %eax,%eax
80103dda:	74 70                	je     80103e4c <wait+0xdc>
80103ddc:	8b 46 24             	mov    0x24(%esi),%eax
80103ddf:	85 c0                	test   %eax,%eax
80103de1:	75 69                	jne    80103e4c <wait+0xdc>
    sleep(curproc, &ptable.lock);  //DOC: wait-sleep
80103de3:	83 ec 08             	sub    $0x8,%esp
80103de6:	68 20 2d 11 80       	push   $0x80112d20
80103deb:	56                   	push   %esi
80103dec:	e8 bf fe ff ff       	call   80103cb0 <sleep>
    havekids = 0;
80103df1:	83 c4 10             	add    $0x10,%esp
80103df4:	eb a4                	jmp    80103d9a <wait+0x2a>
        kfree(p->kstack);
80103df6:	83 ec 0c             	sub    $0xc,%esp
80103df9:	ff 73 08             	pushl  0x8(%ebx)
        pid = p->pid;
80103dfc:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
80103dff:	e8 dc e4 ff ff       	call   801022e0 <kfree>
        freevm(p->pgdir);
80103e04:	5a                   	pop    %edx
80103e05:	ff 73 04             	pushl  0x4(%ebx)
        p->kstack = 0;
80103e08:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103e0f:	e8 4c 2e 00 00       	call   80106c60 <freevm>
        p->pid = 0;
...
80103e3b:	e8 10 06 00 00       	call   80104450 <release>
        return pid;
80103e40:	83 c4 10             	add    $0x10,%esp
}
80103e43:	8d 65 f8             	lea    -0x8(%ebp),%esp
...
80103e4c:	83 ec 0c             	sub    $0xc,%esp
      return -1;
80103e4f:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80103e54:	68 20 2d 11 80       	push   $0x80112d20
80103e59:	e8 f2 05 00 00       	call   80104450 <release>
      return -1;
...
80103e7f:	e8 1c 05 00 00       	call   801043a0 <acquire>
80103e84:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103e87:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103e8c:	eb 0e                	jmp    80103e9c <wakeup+0x2c>
80103e8e:	66 90                	xchg   %ax,%ax
80103e90:	05 88 00 00 00       	add    $0x88,%eax
80103e95:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
80103e9a:	73 1e                	jae    80103eba <wakeup+0x4a>
    if(p->state == SLEEPING && p->chan == chan)
...
80103ea7:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103eae:	05 88 00 00 00       	add    $0x88,%eax
80103eb3:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
80103eb8:	72 e2                	jb     80103e9c <wakeup+0x2c>
  wakeup1(chan);
  release(&ptable.lock);
80103eba:	c7 45 08 20 2d 11 80 	movl   $0x80112d20,0x8(%ebp)
}
80103ec1:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80103ec4:	c9                   	leave  
  release(&ptable.lock);
80103ec5:	e9 86 05 00 00       	jmp    80104450 <release>
...
80103f16:	e8 35 05 00 00       	call   80104450 <release>
      return 0;
...
80103f40:	e8 0b 05 00 00       	call   80104450 <release>
  return -1;
...
80103f66:	8d 75 e8             	lea    -0x18(%ebp),%esi
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f69:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
{
80103f6e:	83 ec 3c             	sub    $0x3c,%esp
80103f71:	eb 27                	jmp    80103f9a <procdump+0x3a>
80103f73:	90                   	nop
...
80103f7b:	68 fb 78 10 80       	push   $0x801078fb
...
80103f94:	0f 83 86 00 00 00    	jae    80104020 <procdump+0xc0>
    if(p->state == UNUSED)
80103f9a:	8b 43 0c             	mov    0xc(%ebx),%eax
80103f9d:	85 c0                	test   %eax,%eax
80103f9f:	74 e7                	je     80103f88 <procdump+0x28>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80103fa1:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80103fa4:	ba 80 75 10 80       	mov    $0x80107580,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80103fa9:	77 11                	ja     80103fbc <procdump+0x5c>
80103fab:	8b 14 85 e0 75 10 80 	mov    -0x7fef8a20(,%eax,4),%edx
      state = "???";
80103fb2:	b8 80 75 10 80       	mov    $0x80107580,%eax
80103fb7:	85 d2                	test   %edx,%edx
80103fb9:	0f 44 d0             	cmove  %eax,%edx
    cprintf("%d %s %s", p->pid, state, p->name);
80103fbc:	8d 43 6c             	lea    0x6c(%ebx),%eax
80103fbf:	50                   	push   %eax
80103fc0:	52                   	push   %edx
80103fc1:	ff 73 10             	pushl  0x10(%ebx)
80103fc4:	68 84 75 10 80       	push   $0x80107584
80103fc9:	e8 92 c6 ff ff       	call   80100660 <cprintf>
    if(p->state == SLEEPING){
80103fce:	83 c4 10             	add    $0x10,%esp
80103fd1:	83 7b 0c 02          	cmpl   $0x2,0xc(%ebx)
80103fd5:	75 a1                	jne    80103f78 <procdump+0x18>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80103fd7:	8d 45 c0             	lea    -0x40(%ebp),%eax
80103fda:	83 ec 08             	sub    $0x8,%esp
80103fdd:	8d 7d c0             	lea    -0x40(%ebp),%edi
80103fe0:	50                   	push   %eax
80103fe1:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103fe4:	8b 40 0c             	mov    0xc(%eax),%eax
80103fe7:	83 c0 08             	add    $0x8,%eax
80103fea:	50                   	push   %eax
80103feb:	e8 70 02 00 00       	call   80104260 <getcallerpcs>
...
80104005:	83 c7 04             	add    $0x4,%edi
80104008:	52                   	push   %edx
80104009:	68 c1 6f 10 80       	push   $0x80106fc1
8010400e:	e8 4d c6 ff ff       	call   80100660 <cprintf>
      for(i=0; i<10 && pc[i] != 0; i++)
80104013:	83 c4 10             	add    $0x10,%esp
80104016:	39 fe                	cmp    %edi,%esi
80104018:	75 de                	jne    80103ff8 <procdump+0x98>
8010401a:	e9 59 ff ff ff       	jmp    80103f78 <procdump+0x18>
8010401f:	90                   	nop
  }
}
80104020:	8d 65 f4             	lea    -0xc(%ebp),%esp
80104023:	5b                   	pop    %ebx
80104024:	5e                   	pop    %esi
80104025:	5f                   	pop    %edi
80104026:	5d                   	pop    %ebp
...
80104036:	83 ec 0c             	sub    $0xc,%esp
  struct cpu *c = mycpu();
80104039:	e8 d2 f6 ff ff       	call   80103710 <mycpu>
8010403e:	8d 70 04             	lea    0x4(%eax),%esi
80104041:	89 c3                	mov    %eax,%ebx
  c->proc = 0;
80104043:	c7 80 ac 00 00 00 00 	movl   $0x0,0xac(%eax)
8010404a:	00 00 00 
...
80104054:	bf 54 2d 11 80       	mov    $0x80112d54,%edi
    acquire(&ptable.lock);
80104059:	68 20 2d 11 80       	push   $0x80112d20
8010405e:	e8 3d 03 00 00       	call   801043a0 <acquire>
80104063:	83 c4 10             	add    $0x10,%esp
    menor = 10000;
80104066:	b9 10 27 00 00       	mov    $0x2710,%ecx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010406b:	89 f8                	mov    %edi,%eax
8010406d:	eb 0d                	jmp    8010407c <scheduler+0x4c>
8010406f:	90                   	nop
80104070:	05 88 00 00 00       	add    $0x88,%eax
80104075:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
8010407a:	73 34                	jae    801040b0 <scheduler+0x80>
      if(p->state != RUNNABLE || (p->passada == 0 && p->pid > 3))
8010407c:	83 78 0c 03          	cmpl   $0x3,0xc(%eax)
80104080:	75 ee                	jne    80104070 <scheduler+0x40>
80104082:	8b 90 84 00 00 00    	mov    0x84(%eax),%edx
80104088:	85 d2                	test   %edx,%edx
8010408a:	75 06                	jne    80104092 <scheduler+0x62>
8010408c:	83 78 10 03          	cmpl   $0x3,0x10(%eax)
80104090:	7f de                	jg     80104070 <scheduler+0x40>
      if(p->passada <= menor){
80104092:	39 ca                	cmp    %ecx,%edx
80104094:	7f da                	jg     80104070 <scheduler+0x40>
80104096:	89 c7                	mov    %eax,%edi
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104098:	05 88 00 00 00       	add    $0x88,%eax
      if(p->passada <= menor){
8010409d:	89 d1                	mov    %edx,%ecx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010409f:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
801040a4:	72 d6                	jb     8010407c <scheduler+0x4c>
801040a6:	8d 76 00             	lea    0x0(%esi),%esi
801040a9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    p->passada = p->passada + p->passo;
801040b0:	8b 87 80 00 00 00    	mov    0x80(%edi),%eax
801040b6:	01 87 84 00 00 00    	add    %eax,0x84(%edi)
    if(p->pid != 1){
801040bc:	83 7f 10 01          	cmpl   $0x1,0x10(%edi)
801040c0:	74 05                	je     801040c7 <scheduler+0x97>
      procdump();
801040c2:	e8 99 fe ff ff       	call   80103f60 <procdump>
    switchuvm(p);
801040c7:	83 ec 0c             	sub    $0xc,%esp
    c->proc = p;
801040ca:	89 bb ac 00 00 00    	mov    %edi,0xac(%ebx)
    switchuvm(p);
801040d0:	57                   	push   %edi
801040d1:	e8 1a 28 00 00       	call   801068f0 <switchuvm>
    p->state = RUNNING;
801040d6:	c7 47 0c 04 00 00 00 	movl   $0x4,0xc(%edi)
    swtch(&(c->scheduler), p->context);
801040dd:	58                   	pop    %eax
801040de:	5a                   	pop    %edx
801040df:	ff 77 1c             	pushl  0x1c(%edi)
801040e2:	56                   	push   %esi
801040e3:	e8 f3 05 00 00       	call   801046db <swtch>
    switchkvm();
801040e8:	e8 e3 27 00 00       	call   801068d0 <switchkvm>
    c->proc = 0;
801040ed:	c7 83 ac 00 00 00 00 	movl   $0x0,0xac(%ebx)
801040f4:	00 00 00 
    release(&ptable.lock);
801040f7:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801040fe:	e8 4d 03 00 00       	call   80104450 <release>
    sti();
80104103:	83 c4 10             	add    $0x10,%esp
80104106:	e9 45 ff ff ff       	jmp    80104050 <scheduler+0x20>
...
8010411a:	68 f8 75 10 80       	push   $0x801075f8
...
80104175:	e8 36 fb ff ff       	call   80103cb0 <sleep>
  while (lk->locked) {
...
80104183:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104189:	e8 22 f6 ff ff       	call   801037b0 <myproc>
...
801041d4:	e8 97 fc ff ff       	call   80103e70 <wakeup>
  release(&lk->lk);
...
80104213:	e8 98 f5 ff ff       	call   801037b0 <myproc>
...
801042c9:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
801042ca:	e8 41 f4 ff ff       	call   80103710 <mycpu>
...
801042df:	e8 2c f4 ff ff       	call   80103710 <mycpu>
801042e4:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
801042ea:	e8 21 f4 ff ff       	call   80103710 <mycpu>
...
8010430b:	75 52                	jne    8010435f <popcli+0x5f>
  ...
  if(--mycpu()->ncli < 0)
8010430d:	e8 fe f3 ff ff       	call   80103710 <mycpu>
...
80104325:	e8 e6 f3 ff ff       	call   80103710 <mycpu>
...
80104339:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104340:	e8 cb f3 ff ff       	call   80103710 <mycpu>
...
80104355:	68 1a 76 10 80       	push   $0x8010761a
8010435a:	e8 11 c0 ff ff       	call   80100370 <panic>
    panic("popcli - interruptible");
8010435f:	83 ec 0c             	sub    $0xc,%esp
80104362:	68 03 76 10 80       	push   $0x80107603
...
80104388:	e8 83 f3 ff ff       	call   80103710 <mycpu>
...
801043a5:	e8 16 ff ff ff       	call   801042c0 <pushcli>
  if(holding(lk))
...
801043bb:	0f 85 7f 00 00 00    	jne    80104440 <acquire+0xa0>
...
801043e4:	e8 27 f3 ff ff       	call   80103710 <mycpu>
  getcallerpcs(&lk, lk->pcs);
801043e9:	8d 56 0c             	lea    0xc(%esi),%edx
  lk->cpu = mycpu();
801043ec:	89 46 08             	mov    %eax,0x8(%esi)
  ebp = (uint*)v - 2;
...
80104409:	89 0c 9a             	mov    %ecx,(%edx,%ebx,4)
  for(i = 0; i < 10; i++){
8010440c:	83 c3 01             	add    $0x1,%ebx
    ebp = (uint*)ebp[0]; // saved %ebp
8010440f:	8b 00                	mov    (%eax),%eax
  for(i = 0; i < 10; i++){
80104411:	83 fb 0a             	cmp    $0xa,%ebx
...
8010441d:	8d 76 00             	lea    0x0(%esi),%esi
    pcs[i] = 0;
80104420:	c7 04 9a 00 00 00 00 	movl   $0x0,(%edx,%ebx,4)
  for(; i < 10; i++)
80104427:	83 c3 01             	add    $0x1,%ebx
8010442a:	83 fb 0a             	cmp    $0xa,%ebx
8010442d:	74 e7                	je     80104416 <acquire+0x76>
    pcs[i] = 0;
8010442f:	c7 04 9a 00 00 00 00 	movl   $0x0,(%edx,%ebx,4)
  for(; i < 10; i++)
80104436:	83 c3 01             	add    $0x1,%ebx
80104439:	83 fb 0a             	cmp    $0xa,%ebx
8010443c:	75 e2                	jne    80104420 <acquire+0x80>
8010443e:	eb d6                	jmp    80104416 <acquire+0x76>
    panic("acquire");
80104440:	83 ec 0c             	sub    $0xc,%esp
80104443:	68 21 76 10 80       	push   $0x80107621
...
8010448c:	68 29 76 10 80       	push   $0x80107629
...
80104562:	8d 14 33             	lea    (%ebx,%esi,1),%edx
...
801045d3:	0f b6 11             	movzbl (%ecx),%edx
...
801045e8:	0f b6 11             	movzbl (%ecx),%edx
801045eb:	84 d2                	test   %dl,%dl
801045ed:	74 21                	je     80104610 <strncmp+0x50>
801045ef:	0f b6 18             	movzbl (%eax),%ebx
801045f2:	89 c6                	mov    %eax,%esi
801045f4:	38 da                	cmp    %bl,%dl
801045f6:	75 1c                	jne    80104614 <strncmp+0x54>
    n--, p++, q++;
801045f8:	8d 46 01             	lea    0x1(%esi),%eax
801045fb:	83 c1 01             	add    $0x1,%ecx
  while(n > 0 && *p && *p == *q)
801045fe:	39 f8                	cmp    %edi,%eax
...
80104610:	0f b6 5e 01          	movzbl 0x1(%esi),%ebx
  return (uchar)*p - (uchar)*q;
80104614:	0f b6 c2             	movzbl %dl,%eax
80104617:	29 d8                	sub    %ebx,%eax
}
80104619:	5b                   	pop    %ebx
8010461a:	5e                   	pop    %esi
8010461b:	5f                   	pop    %edi
...
801046f7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
801046fa:	e8 b1 f0 ff ff       	call   801037b0 <myproc>
...
80104795:	e8 16 f0 ff ff       	call   801037b0 <myproc>
...
801047a3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
801047a6:	e8 05 f0 ff ff       	call   801037b0 <myproc>
  if(addr >= curproc->sz || addr+4 > curproc->sz)
...
801047e8:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
801047eb:	e8 c0 ef ff ff       	call   801037b0 <myproc>
...
8010489a:	8b 14 85 60 76 10 80 	mov    -0x7fef89a0(,%eax,4),%edx
...
801048c0:	68 31 76 10 80       	push   $0x80107631
...
801048e6:	8d 5d da             	lea    -0x26(%ebp),%ebx
{
...
80104947:	66 83 7f 50 02       	cmpw   $0x2,0x50(%edi)
...
80104964:	31 ff                	xor    %edi,%edi
    iunlockput(ip);
80104966:	e8 95 cf ff ff       	call   80101900 <iunlockput>
    return 0;
...
80104a09:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    dp->nlink++;  // for ".."
80104a10:	66 83 46 56 01       	addw   $0x1,0x56(%esi)
    iupdate(dp);
...
80104a24:	68 d8 76 10 80       	push   $0x801076d8
...
80104a3c:	68 d7 76 10 80       	push   $0x801076d7
...
80104aa4:	e8 07 ed ff ff       	call   801037b0 <myproc>
...
80104b20:	8d 65 f8             	lea    -0x8(%ebp),%esp
    return -1;
80104b23:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
}
...
80104b3a:	e8 91 c2 ff ff       	call   80100dd0 <filedup>
  return fd;
...
80104c0d:	e8 be c3 ff ff       	call   80100fd0 <filewrite>
...
80104c43:	78 2b                	js     80104c70 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104c45:	e8 66 eb ff ff       	call   801037b0 <myproc>
...
80104c5b:	e8 c0 c1 ff ff       	call   80100e20 <fileclose>
  return 0;
...
80104cb4:	e8 37 c2 ff ff       	call   80100ef0 <filestat>
...
80104d02:	0f 88 e2 00 00 00    	js     80104dea <sys_link+0x11a>
  begin_op();
80104d08:	e8 63 de ff ff       	call   80102b70 <begin_op>
  if((ip = namei(old)) == 0){
...
80104d9b:	e8 00 ca ff ff       	call   801017a0 <iput>
  end_op();
80104da0:	e8 3b de ff ff       	call   80102be0 <end_op>
  return 0;
...
80104ddd:	e8 1e cb ff ff       	call   80101900 <iunlockput>
  end_op();
80104de2:	e8 f9 dd ff ff       	call   80102be0 <end_op>
  return -1;
...
80104e4f:	8d 5d ca             	lea    -0x36(%ebp),%ebx
  begin_op();
80104e52:	e8 19 dd ff ff       	call   80102b70 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
...
80104ef2:	e8 a9 f5 ff ff       	call   801044a0 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
80104f97:	e8 64 c9 ff ff       	call   80101900 <iunlockput>
  end_op();
80104f9c:	e8 3f dc ff ff       	call   80102be0 <end_op>
  return -1;
...
80104fd6:	e9 6b ff ff ff       	jmp    80104f46 <sys_unlink+0x116>
    end_op();
80104fdb:	e8 00 dc ff ff       	call   80102be0 <end_op>
    return -1;
...
80105052:	0f 88 85 00 00 00    	js     801050dd <sys_open+0xbd>
  ...
  begin_op();
80105058:	e8 13 db ff ff       	call   80102b70 <begin_op>
...
80105096:	e8 c5 bc ff ff       	call   80100d60 <filealloc>
...
801050a1:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
801050a3:	e8 08 e7 ff ff       	call   801037b0 <myproc>
801050a8:	90                   	nop
...
801050c4:	e8 57 bd ff ff       	call   80100e20 <fileclose>
...
801050d0:	e8 2b c8 ff ff       	call   80101900 <iunlockput>
    end_op();
801050d5:	e8 06 db ff ff       	call   80102be0 <end_op>
    return -1;
...
8010514c:	88 57 08             	mov    %dl,0x8(%edi)
8010514f:	80 67 08 01          	andb   $0x1,0x8(%edi)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105153:	a8 03                	test   $0x3,%al
80105155:	0f 95 47 09          	setne  0x9(%edi)
}
...
801051bf:	e8 3c c7 ff ff       	call   80101900 <iunlockput>
  end_op();
801051c4:	e8 17 da ff ff       	call   80102be0 <end_op>
  return 0;
...
801051cf:	c3                   	ret    
    end_op();
801051d0:	e8 0b da ff ff       	call   80102be0 <end_op>
    return -1;
...
801051e3:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
801051e6:	e8 85 d9 ff ff       	call   80102b70 <begin_op>
  if((argstr(0, &path)) < 0 ||
...
8010524e:	e8 ad c6 ff ff       	call   80101900 <iunlockput>
  end_op();
80105253:	e8 88 d9 ff ff       	call   80102be0 <end_op>
  return 0;
...
8010525f:	90                   	nop
    end_op();
80105260:	e8 7b d9 ff ff       	call   80102be0 <end_op>
    return -1;
...
80105275:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105278:	e8 33 e5 ff ff       	call   801037b0 <myproc>
8010527d:	89 c6                	mov    %eax,%esi
  
  begin_op();
8010527f:	e8 ec d8 ff ff       	call   80102b70 <begin_op>
...
801052cd:	e8 ce c4 ff ff       	call   801017a0 <iput>
  end_op();
801052d2:	e8 09 d9 ff ff       	call   80102be0 <end_op>
  curproc->cwd = ip;
...
801052f4:	e8 07 c6 ff ff       	call   80101900 <iunlockput>
    end_op();
801052f9:	e8 e2 d8 ff ff       	call   80102be0 <end_op>
    return -1;
...
80105378:	e8 23 f1 ff ff       	call   801044a0 <memset>
...
80105428:	e8 d3 dd ff ff       	call   80103200 <pipealloc>
...
80105436:	8b 7d e0             	mov    -0x20(%ebp),%edi
  struct proc *curproc = myproc();
80105439:	e8 72 e3 ff ff       	call   801037b0 <myproc>
...
80105456:	e8 c5 b9 ff ff       	call   80100e20 <fileclose>
    fileclose(wf);
8010545b:	58                   	pop    %eax
8010545c:	ff 75 e4             	pushl  -0x1c(%ebp)
8010545f:	e8 bc b9 ff ff       	call   80100e20 <fileclose>
    return -1;
...
8010547f:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
80105482:	e8 29 e3 ff ff       	call   801037b0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
8010549e:	75 f0                	jne    80105490 <sys_pipe+0x90>
      myproc()->ofile[fd0] = 0;
801054a0:	e8 0b e3 ff ff       	call   801037b0 <myproc>
...
801054d3:	5d                   	pop    %ebp
  return fork();
801054d4:	e9 77 e4 ff ff       	jmp    80103950 <fork>
...
801054e3:	83 ec 08             	sub    $0x8,%esp
  exit();
801054e6:	e8 45 e6 ff ff       	call   80103b30 <exit>
...
801054f3:	5d                   	pop    %ebp
  return wait();
801054f4:	e9 77 e8 ff ff       	jmp    80103d70 <wait>
...
8010551e:	e8 ad e9 ff ff       	call   80103ed0 <kill>
...
80105543:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105546:	e8 65 e2 ff ff       	call   801037b0 <myproc>
...
80105567:	78 27                	js     80105590 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80105569:	e8 42 e2 ff ff       	call   801037b0 <myproc>
  if(growproc(n) < 0)
...
80105576:	e8 55 e3 ff ff       	call   801038d0 <growproc>
...
801055c5:	e8 d6 ed ff ff       	call   801043a0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801055ca:	8b 55 f4             	mov    -0xc(%ebp),%edx
801055cd:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
801055d0:	8b 1d a0 57 11 80    	mov    0x801157a0,%ebx
  while(ticks - ticks0 < n){
...
801055e8:	68 a0 57 11 80       	push   $0x801157a0
801055ed:	e8 be e6 ff ff       	call   80103cb0 <sleep>
  while(ticks - ticks0 < n){
801055f2:	a1 a0 57 11 80       	mov    0x801157a0,%eax
...
801055ff:	73 2f                	jae    80105630 <sys_sleep+0x90>
    if(myproc()->killed){
80105601:	e8 aa e1 ff ff       	call   801037b0 <myproc>
...
80105610:	68 60 4f 11 80       	push   $0x80114f60
...
80105633:	68 60 4f 11 80       	push   $0x80114f60
...
80105654:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105657:	68 60 4f 11 80       	push   $0x80114f60
8010565c:	e8 3f ed ff ff       	call   801043a0 <acquire>
  xticks = ticks;
80105661:	8b 1d a0 57 11 80    	mov    0x801157a0,%ebx
  release(&tickslock);
80105667:	c7 04 24 60 4f 11 80 	movl   $0x80114f60,(%esp)
...
8010568d:	e8 fe f0 ff ff       	call   80104790 <argint>
80105692:	83 c4 10             	add    $0x10,%esp
80105695:	85 c0                	test   %eax,%eax
80105697:	78 47                	js     801056e0 <sys_settickets+0x60>
    return -1;

  myproc()->tickets = n;
80105699:	e8 12 e1 ff ff       	call   801037b0 <myproc>
8010569e:	8b 55 f4             	mov    -0xc(%ebp),%edx
801056a1:	89 50 7c             	mov    %edx,0x7c(%eax)
  //Calcular passo do processo
  myproc()->passo = (10000/n);
801056a4:	e8 07 e1 ff ff       	call   801037b0 <myproc>
801056a9:	89 c1                	mov    %eax,%ecx
801056ab:	b8 10 27 00 00       	mov    $0x2710,%eax
801056b0:	99                   	cltd   
801056b1:	f7 7d f4             	idivl  -0xc(%ebp)
801056b4:	89 81 80 00 00 00    	mov    %eax,0x80(%ecx)
  myproc()->passada = myproc()->passo;
801056ba:	e8 f1 e0 ff ff       	call   801037b0 <myproc>
801056bf:	89 c3                	mov    %eax,%ebx
801056c1:	e8 ea e0 ff ff       	call   801037b0 <myproc>
801056c6:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
801056cc:	89 83 84 00 00 00    	mov    %eax,0x84(%ebx)
  return n;
...
801056e5:	eb ee                	jmp    801056d5 <sys_settickets+0x55>
...
801056f6:	54                   	push   %esp
  call trap
801056f7:	e8 e4 00 00 00       	call   801057e0 <trap>
  addl $4, %esp
...
80105727:	b9 08 00 00 00       	mov    $0x8,%ecx
8010572c:	c6 04 c5 a4 4f 11 80 	movb   $0x0,-0x7feeb05c(,%eax,8)
80105733:	00 
80105734:	66 89 0c c5 a2 4f 11 	mov    %cx,-0x7feeb05e(,%eax,8)
8010573b:	80 
8010573c:	c6 04 c5 a5 4f 11 80 	movb   $0x8e,-0x7feeb05b(,%eax,8)
80105743:	8e 
80105744:	66 89 14 c5 a0 4f 11 	mov    %dx,-0x7feeb060(,%eax,8)
8010574b:	80 
8010574c:	c1 ea 10             	shr    $0x10,%edx
8010574f:	66 89 14 c5 a6 4f 11 	mov    %dx,-0x7feeb05a(,%eax,8)
80105756:	80 
  for(i = 0; i < 256; i++)
80105757:	83 c0 01             	add    $0x1,%eax
8010575a:	3d 00 01 00 00       	cmp    $0x100,%eax
8010575f:	75 bf                	jne    80105720 <tvinit+0x10>
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105761:	a1 08 a1 10 80       	mov    0x8010a108,%eax

  initlock(&tickslock, "time");
80105766:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105769:	ba 08 00 00 00       	mov    $0x8,%edx
  initlock(&tickslock, "time");
8010576e:	68 1d 77 10 80       	push   $0x8010771d
80105773:	68 60 4f 11 80       	push   $0x80114f60
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105778:	66 89 15 a2 51 11 80 	mov    %dx,0x801151a2
8010577f:	c6 05 a4 51 11 80 00 	movb   $0x0,0x801151a4
80105786:	66 a3 a0 51 11 80    	mov    %ax,0x801151a0
8010578c:	c1 e8 10             	shr    $0x10,%eax
8010578f:	c6 05 a5 51 11 80 ef 	movb   $0xef,0x801151a5
80105796:	66 a3 a6 51 11 80    	mov    %ax,0x801151a6
  initlock(&tickslock, "time");
8010579c:	e8 9f ea ff ff       	call   80104240 <initlock>
}
...
80105800:	ff 24 85 c4 77 10 80 	jmp    *-0x7fef883c(,%eax,4)
...
80105865:	68 80 77 10 80       	push   $0x80107780
8010586a:	e8 f1 ad ff ff       	call   80100660 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
8010586f:	83 c4 20             	add    $0x20,%esp
80105872:	e8 39 df ff ff       	call   801037b0 <myproc>
...
80105880:	e8 2b df ff ff       	call   801037b0 <myproc>
...
80105895:	e8 16 df ff ff       	call   801037b0 <myproc>
8010589a:	85 c0                	test   %eax,%eax
8010589c:	74 0b                	je     801058a9 <trap+0xc9>
8010589e:	e8 0d df ff ff       	call   801037b0 <myproc>
...
801058eb:	75 a8                	jne    80105895 <trap+0xb5>
    exit();
801058ed:	e8 3e e2 ff ff       	call   80103b30 <exit>
...
801058fc:	75 ab                	jne    801058a9 <trap+0xc9>
    yield();
801058fe:	e8 5d e3 ff ff       	call   80103c60 <yield>
80105903:	eb a4                	jmp    801058a9 <trap+0xc9>
80105905:	8d 76 00             	lea    0x0(%esi),%esi
    if(cpuid() == 0){
80105908:	e8 83 de ff ff       	call   80103790 <cpuid>
...
8010591f:	90                   	nop
    kbdintr();
80105920:	e8 bb cc ff ff       	call   801025e0 <kbdintr>
    lapiceoi();
80105925:	e8 f6 cd ff ff       	call   80102720 <lapiceoi>
    break;
...
80105930:	e8 5b 02 00 00       	call   80105b90 <uartintr>
    lapiceoi();
80105935:	e8 e6 cd ff ff       	call   80102720 <lapiceoi>
    break;
...
80105947:	e8 44 de ff ff       	call   80103790 <cpuid>
8010594c:	56                   	push   %esi
8010594d:	53                   	push   %ebx
8010594e:	50                   	push   %eax
8010594f:	68 28 77 10 80       	push   $0x80107728
80105954:	e8 07 ad ff ff       	call   80100660 <cprintf>
    lapiceoi();
80105959:	e8 c2 cd ff ff       	call   80102720 <lapiceoi>
    break;
...
80105979:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    if(myproc()->killed)
80105980:	e8 2b de ff ff       	call   801037b0 <myproc>
80105985:	8b 58 24             	mov    0x24(%eax),%ebx
80105988:	85 db                	test   %ebx,%ebx
8010598a:	75 2c                	jne    801059b8 <trap+0x1d8>
    myproc()->tf = tf;
8010598c:	e8 1f de ff ff       	call   801037b0 <myproc>
80105991:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105994:	e8 e7 ee ff ff       	call   80104880 <syscall>
    if(myproc()->killed)
...
801059af:	5d                   	pop    %ebp
      exit();
801059b0:	e9 7b e1 ff ff       	jmp    80103b30 <exit>
801059b5:	8d 76 00             	lea    0x0(%esi),%esi
      exit();
801059b8:	e8 73 e1 ff ff       	call   80103b30 <exit>
801059bd:	eb cd                	jmp    8010598c <trap+0x1ac>
801059bf:	90                   	nop
      acquire(&tickslock);
801059c0:	83 ec 0c             	sub    $0xc,%esp
801059c3:	68 60 4f 11 80       	push   $0x80114f60
801059c8:	e8 d3 e9 ff ff       	call   801043a0 <acquire>
      wakeup(&ticks);
801059cd:	c7 04 24 a0 57 11 80 	movl   $0x801157a0,(%esp)
      ticks++;
801059d4:	83 05 a0 57 11 80 01 	addl   $0x1,0x801157a0
      wakeup(&ticks);
801059db:	e8 90 e4 ff ff       	call   80103e70 <wakeup>
      release(&tickslock);
801059e0:	c7 04 24 60 4f 11 80 	movl   $0x80114f60,(%esp)
...
801059fa:	e8 91 dd ff ff       	call   80103790 <cpuid>
...
80105a75:	e8 c6 cc ff ff       	call   80102740 <microdelay>
...
80105b0f:	bb 44 78 10 80       	mov    $0x80107844,%ebx
...
80105b9b:	e8 40 ac ff ff       	call   801007e0 <consoleintr>
}
...
80105ba7:	6a 00                	push   $0x0
  jmp alltraps
80105ba9:	e9 39 fb ff ff       	jmp    801056e7 <alltraps>
...
80105bb0:	6a 01                	push   $0x1
  jmp alltraps
80105bb2:	e9 30 fb ff ff       	jmp    801056e7 <alltraps>
...
80105bb9:	6a 02                	push   $0x2
  jmp alltraps
80105bbb:	e9 27 fb ff ff       	jmp    801056e7 <alltraps>
...
80105bc2:	6a 03                	push   $0x3
  jmp alltraps
80105bc4:	e9 1e fb ff ff       	jmp    801056e7 <alltraps>
...
80105bcb:	6a 04                	push   $0x4
  jmp alltraps
80105bcd:	e9 15 fb ff ff       	jmp    801056e7 <alltraps>
...
80105bd4:	6a 05                	push   $0x5
  jmp alltraps
80105bd6:	e9 0c fb ff ff       	jmp    801056e7 <alltraps>
...
80105bdd:	6a 06                	push   $0x6
  jmp alltraps
80105bdf:	e9 03 fb ff ff       	jmp    801056e7 <alltraps>
...
80105be6:	6a 07                	push   $0x7
  jmp alltraps
80105be8:	e9 fa fa ff ff       	jmp    801056e7 <alltraps>
...
80105bed:	6a 08                	push   $0x8
  jmp alltraps
80105bef:	e9 f3 fa ff ff       	jmp    801056e7 <alltraps>
...
80105bf6:	6a 09                	push   $0x9
  jmp alltraps
80105bf8:	e9 ea fa ff ff       	jmp    801056e7 <alltraps>
...
80105bfd:	6a 0a                	push   $0xa
  jmp alltraps
80105bff:	e9 e3 fa ff ff       	jmp    801056e7 <alltraps>
...
80105c04:	6a 0b                	push   $0xb
  jmp alltraps
80105c06:	e9 dc fa ff ff       	jmp    801056e7 <alltraps>
...
80105c0b:	6a 0c                	push   $0xc
  jmp alltraps
80105c0d:	e9 d5 fa ff ff       	jmp    801056e7 <alltraps>
...
80105c12:	6a 0d                	push   $0xd
  jmp alltraps
80105c14:	e9 ce fa ff ff       	jmp    801056e7 <alltraps>
...
80105c19:	6a 0e                	push   $0xe
  jmp alltraps
80105c1b:	e9 c7 fa ff ff       	jmp    801056e7 <alltraps>
...
80105c22:	6a 0f                	push   $0xf
  jmp alltraps
80105c24:	e9 be fa ff ff       	jmp    801056e7 <alltraps>
...
80105c2b:	6a 10                	push   $0x10
  jmp alltraps
80105c2d:	e9 b5 fa ff ff       	jmp    801056e7 <alltraps>
...
80105c32:	6a 11                	push   $0x11
  jmp alltraps
80105c34:	e9 ae fa ff ff       	jmp    801056e7 <alltraps>
...
80105c3b:	6a 12                	push   $0x12
  jmp alltraps
80105c3d:	e9 a5 fa ff ff       	jmp    801056e7 <alltraps>
...
80105c44:	6a 13                	push   $0x13
  jmp alltraps
80105c46:	e9 9c fa ff ff       	jmp    801056e7 <alltraps>
...
80105c4d:	6a 14                	push   $0x14
  jmp alltraps
80105c4f:	e9 93 fa ff ff       	jmp    801056e7 <alltraps>
...
80105c56:	6a 15                	push   $0x15
  jmp alltraps
80105c58:	e9 8a fa ff ff       	jmp    801056e7 <alltraps>
...
80105c5f:	6a 16                	push   $0x16
  jmp alltraps
80105c61:	e9 81 fa ff ff       	jmp    801056e7 <alltraps>
...
80105c68:	6a 17                	push   $0x17
  jmp alltraps
80105c6a:	e9 78 fa ff ff       	jmp    801056e7 <alltraps>
...
80105c71:	6a 18                	push   $0x18
  jmp alltraps
80105c73:	e9 6f fa ff ff       	jmp    801056e7 <alltraps>
...
80105c7a:	6a 19                	push   $0x19
  jmp alltraps
80105c7c:	e9 66 fa ff ff       	jmp    801056e7 <alltraps>
...
80105c83:	6a 1a                	push   $0x1a
  jmp alltraps
80105c85:	e9 5d fa ff ff       	jmp    801056e7 <alltraps>
...
80105c8c:	6a 1b                	push   $0x1b
  jmp alltraps
80105c8e:	e9 54 fa ff ff       	jmp    801056e7 <alltraps>
...
80105c95:	6a 1c                	push   $0x1c
  jmp alltraps
80105c97:	e9 4b fa ff ff       	jmp    801056e7 <alltraps>
...
80105c9e:	6a 1d                	push   $0x1d
  jmp alltraps
80105ca0:	e9 42 fa ff ff       	jmp    801056e7 <alltraps>
...
80105ca7:	6a 1e                	push   $0x1e
  jmp alltraps
80105ca9:	e9 39 fa ff ff       	jmp    801056e7 <alltraps>
...
80105cb0:	6a 1f                	push   $0x1f
  jmp alltraps
80105cb2:	e9 30 fa ff ff       	jmp    801056e7 <alltraps>
...
80105cb9:	6a 20                	push   $0x20
  jmp alltraps
80105cbb:	e9 27 fa ff ff       	jmp    801056e7 <alltraps>
...
80105cc2:	6a 21                	push   $0x21
  jmp alltraps
80105cc4:	e9 1e fa ff ff       	jmp    801056e7 <alltraps>
...
80105ccb:	6a 22                	push   $0x22
  jmp alltraps
80105ccd:	e9 15 fa ff ff       	jmp    801056e7 <alltraps>
...
80105cd4:	6a 23                	push   $0x23
  jmp alltraps
80105cd6:	e9 0c fa ff ff       	jmp    801056e7 <alltraps>
...
80105cdd:	6a 24                	push   $0x24
  jmp alltraps
80105cdf:	e9 03 fa ff ff       	jmp    801056e7 <alltraps>
...
80105ce6:	6a 25                	push   $0x25
  jmp alltraps
80105ce8:	e9 fa f9 ff ff       	jmp    801056e7 <alltraps>
...
80105cef:	6a 26                	push   $0x26
  jmp alltraps
80105cf1:	e9 f1 f9 ff ff       	jmp    801056e7 <alltraps>
...
80105cf8:	6a 27                	push   $0x27
  jmp alltraps
80105cfa:	e9 e8 f9 ff ff       	jmp    801056e7 <alltraps>
...
80105d01:	6a 28                	push   $0x28
  jmp alltraps
80105d03:	e9 df f9 ff ff       	jmp    801056e7 <alltraps>
...
80105d0a:	6a 29                	push   $0x29
  jmp alltraps
80105d0c:	e9 d6 f9 ff ff       	jmp    801056e7 <alltraps>
...
80105d13:	6a 2a                	push   $0x2a
  jmp alltraps
80105d15:	e9 cd f9 ff ff       	jmp    801056e7 <alltraps>
...
80105d1c:	6a 2b                	push   $0x2b
  jmp alltraps
80105d1e:	e9 c4 f9 ff ff       	jmp    801056e7 <alltraps>
...
80105d25:	6a 2c                	push   $0x2c
  jmp alltraps
80105d27:	e9 bb f9 ff ff       	jmp    801056e7 <alltraps>
...
80105d2e:	6a 2d                	push   $0x2d
  jmp alltraps
80105d30:	e9 b2 f9 ff ff       	jmp    801056e7 <alltraps>
...
80105d37:	6a 2e                	push   $0x2e
  jmp alltraps
80105d39:	e9 a9 f9 ff ff       	jmp    801056e7 <alltraps>
...
80105d40:	6a 2f                	push   $0x2f
  jmp alltraps
80105d42:	e9 a0 f9 ff ff       	jmp    801056e7 <alltraps>
...
80105d49:	6a 30                	push   $0x30
  jmp alltraps
80105d4b:	e9 97 f9 ff ff       	jmp    801056e7 <alltraps>
...
80105d52:	6a 31                	push   $0x31
  jmp alltraps
80105d54:	e9 8e f9 ff ff       	jmp    801056e7 <alltraps>
...
80105d5b:	6a 32                	push   $0x32
  jmp alltraps
80105d5d:	e9 85 f9 ff ff       	jmp    801056e7 <alltraps>
...
80105d64:	6a 33                	push   $0x33
  jmp alltraps
80105d66:	e9 7c f9 ff ff       	jmp    801056e7 <alltraps>
...
80105d6d:	6a 34                	push   $0x34
  jmp alltraps
80105d6f:	e9 73 f9 ff ff       	jmp    801056e7 <alltraps>
...
80105d76:	6a 35                	push   $0x35
  jmp alltraps
80105d78:	e9 6a f9 ff ff       	jmp    801056e7 <alltraps>
...
80105d7f:	6a 36                	push   $0x36
  jmp alltraps
80105d81:	e9 61 f9 ff ff       	jmp    801056e7 <alltraps>
...
80105d88:	6a 37                	push   $0x37
  jmp alltraps
80105d8a:	e9 58 f9 ff ff       	jmp    801056e7 <alltraps>
...
80105d91:	6a 38                	push   $0x38
  jmp alltraps
80105d93:	e9 4f f9 ff ff       	jmp    801056e7 <alltraps>
...
80105d9a:	6a 39                	push   $0x39
  jmp alltraps
80105d9c:	e9 46 f9 ff ff       	jmp    801056e7 <alltraps>
...
80105da3:	6a 3a                	push   $0x3a
  jmp alltraps
80105da5:	e9 3d f9 ff ff       	jmp    801056e7 <alltraps>
...
80105dac:	6a 3b                	push   $0x3b
  jmp alltraps
80105dae:	e9 34 f9 ff ff       	jmp    801056e7 <alltraps>
...
80105db5:	6a 3c                	push   $0x3c
  jmp alltraps
80105db7:	e9 2b f9 ff ff       	jmp    801056e7 <alltraps>
...
80105dbe:	6a 3d                	push   $0x3d
  jmp alltraps
80105dc0:	e9 22 f9 ff ff       	jmp    801056e7 <alltraps>
...
80105dc7:	6a 3e                	push   $0x3e
  jmp alltraps
80105dc9:	e9 19 f9 ff ff       	jmp    801056e7 <alltraps>
...
80105dd0:	6a 3f                	push   $0x3f
  jmp alltraps
80105dd2:	e9 10 f9 ff ff       	jmp    801056e7 <alltraps>
...
80105dd9:	6a 40                	push   $0x40
  jmp alltraps
80105ddb:	e9 07 f9 ff ff       	jmp    801056e7 <alltraps>
...
80105de2:	6a 41                	push   $0x41
  jmp alltraps
80105de4:	e9 fe f8 ff ff       	jmp    801056e7 <alltraps>
...
80105deb:	6a 42                	push   $0x42
  jmp alltraps
80105ded:	e9 f5 f8 ff ff       	jmp    801056e7 <alltraps>
...
80105df4:	6a 43                	push   $0x43
  jmp alltraps
80105df6:	e9 ec f8 ff ff       	jmp    801056e7 <alltraps>
...
80105dfd:	6a 44                	push   $0x44
  jmp alltraps
80105dff:	e9 e3 f8 ff ff       	jmp    801056e7 <alltraps>
...
80105e06:	6a 45                	push   $0x45
  jmp alltraps
80105e08:	e9 da f8 ff ff       	jmp    801056e7 <alltraps>
...
80105e0f:	6a 46                	push   $0x46
  jmp alltraps
80105e11:	e9 d1 f8 ff ff       	jmp    801056e7 <alltraps>
...
80105e18:	6a 47                	push   $0x47
  jmp alltraps
80105e1a:	e9 c8 f8 ff ff       	jmp    801056e7 <alltraps>
...
80105e21:	6a 48                	push   $0x48
  jmp alltraps
80105e23:	e9 bf f8 ff ff       	jmp    801056e7 <alltraps>
...
80105e2a:	6a 49                	push   $0x49
  jmp alltraps
80105e2c:	e9 b6 f8 ff ff       	jmp    801056e7 <alltraps>
...
80105e33:	6a 4a                	push   $0x4a
  jmp alltraps
80105e35:	e9 ad f8 ff ff       	jmp    801056e7 <alltraps>
...
80105e3c:	6a 4b                	push   $0x4b
  jmp alltraps
80105e3e:	e9 a4 f8 ff ff       	jmp    801056e7 <alltraps>
...
80105e45:	6a 4c                	push   $0x4c
  jmp alltraps
80105e47:	e9 9b f8 ff ff       	jmp    801056e7 <alltraps>
...
80105e4e:	6a 4d                	push   $0x4d
  jmp alltraps
80105e50:	e9 92 f8 ff ff       	jmp    801056e7 <alltraps>
...
80105e57:	6a 4e                	push   $0x4e
  jmp alltraps
80105e59:	e9 89 f8 ff ff       	jmp    801056e7 <alltraps>
...
80105e60:	6a 4f                	push   $0x4f
  jmp alltraps
80105e62:	e9 80 f8 ff ff       	jmp    801056e7 <alltraps>
...
80105e69:	6a 50                	push   $0x50
  jmp alltraps
80105e6b:	e9 77 f8 ff ff       	jmp    801056e7 <alltraps>
...
80105e72:	6a 51                	push   $0x51
  jmp alltraps
80105e74:	e9 6e f8 ff ff       	jmp    801056e7 <alltraps>
...
80105e7b:	6a 52                	push   $0x52
  jmp alltraps
80105e7d:	e9 65 f8 ff ff       	jmp    801056e7 <alltraps>
...
80105e84:	6a 53                	push   $0x53
  jmp alltraps
80105e86:	e9 5c f8 ff ff       	jmp    801056e7 <alltraps>
...
80105e8d:	6a 54                	push   $0x54
  jmp alltraps
80105e8f:	e9 53 f8 ff ff       	jmp    801056e7 <alltraps>
...
80105e96:	6a 55                	push   $0x55
  jmp alltraps
80105e98:	e9 4a f8 ff ff       	jmp    801056e7 <alltraps>
...
80105e9f:	6a 56                	push   $0x56
  jmp alltraps
80105ea1:	e9 41 f8 ff ff       	jmp    801056e7 <alltraps>
...
80105ea8:	6a 57                	push   $0x57
  jmp alltraps
80105eaa:	e9 38 f8 ff ff       	jmp    801056e7 <alltraps>
...
80105eb1:	6a 58                	push   $0x58
  jmp alltraps
80105eb3:	e9 2f f8 ff ff       	jmp    801056e7 <alltraps>
...
80105eba:	6a 59                	push   $0x59
  jmp alltraps
80105ebc:	e9 26 f8 ff ff       	jmp    801056e7 <alltraps>
...
80105ec3:	6a 5a                	push   $0x5a
  jmp alltraps
80105ec5:	e9 1d f8 ff ff       	jmp    801056e7 <alltraps>
...
80105ecc:	6a 5b                	push   $0x5b
  jmp alltraps
80105ece:	e9 14 f8 ff ff       	jmp    801056e7 <alltraps>
...
80105ed5:	6a 5c                	push   $0x5c
  jmp alltraps
80105ed7:	e9 0b f8 ff ff       	jmp    801056e7 <alltraps>
...
80105ede:	6a 5d                	push   $0x5d
  jmp alltraps
80105ee0:	e9 02 f8 ff ff       	jmp    801056e7 <alltraps>
...
80105ee7:	6a 5e                	push   $0x5e
  jmp alltraps
80105ee9:	e9 f9 f7 ff ff       	jmp    801056e7 <alltraps>
...
80105ef0:	6a 5f                	push   $0x5f
  jmp alltraps
80105ef2:	e9 f0 f7 ff ff       	jmp    801056e7 <alltraps>
...
80105ef9:	6a 60                	push   $0x60
  jmp alltraps
80105efb:	e9 e7 f7 ff ff       	jmp    801056e7 <alltraps>
...
80105f02:	6a 61                	push   $0x61
  jmp alltraps
80105f04:	e9 de f7 ff ff       	jmp    801056e7 <alltraps>
...
80105f0b:	6a 62                	push   $0x62
  jmp alltraps
80105f0d:	e9 d5 f7 ff ff       	jmp    801056e7 <alltraps>
...
80105f14:	6a 63                	push   $0x63
  jmp alltraps
80105f16:	e9 cc f7 ff ff       	jmp    801056e7 <alltraps>
...
80105f1d:	6a 64                	push   $0x64
  jmp alltraps
80105f1f:	e9 c3 f7 ff ff       	jmp    801056e7 <alltraps>
...
80105f26:	6a 65                	push   $0x65
  jmp alltraps
80105f28:	e9 ba f7 ff ff       	jmp    801056e7 <alltraps>
...
80105f2f:	6a 66                	push   $0x66
  jmp alltraps
80105f31:	e9 b1 f7 ff ff       	jmp    801056e7 <alltraps>
...
80105f38:	6a 67                	push   $0x67
  jmp alltraps
80105f3a:	e9 a8 f7 ff ff       	jmp    801056e7 <alltraps>
...
80105f41:	6a 68                	push   $0x68
  jmp alltraps
80105f43:	e9 9f f7 ff ff       	jmp    801056e7 <alltraps>
...
80105f4a:	6a 69                	push   $0x69
  jmp alltraps
80105f4c:	e9 96 f7 ff ff       	jmp    801056e7 <alltraps>
...
80105f53:	6a 6a                	push   $0x6a
  jmp alltraps
80105f55:	e9 8d f7 ff ff       	jmp    801056e7 <alltraps>
...
80105f5c:	6a 6b                	push   $0x6b
  jmp alltraps
80105f5e:	e9 84 f7 ff ff       	jmp    801056e7 <alltraps>
...
80105f65:	6a 6c                	push   $0x6c
  jmp alltraps
80105f67:	e9 7b f7 ff ff       	jmp    801056e7 <alltraps>
...
80105f6e:	6a 6d                	push   $0x6d
  jmp alltraps
80105f70:	e9 72 f7 ff ff       	jmp    801056e7 <alltraps>
...
80105f77:	6a 6e                	push   $0x6e
  jmp alltraps
80105f79:	e9 69 f7 ff ff       	jmp    801056e7 <alltraps>
...
80105f80:	6a 6f                	push   $0x6f
  jmp alltraps
80105f82:	e9 60 f7 ff ff       	jmp    801056e7 <alltraps>
...
80105f89:	6a 70                	push   $0x70
  jmp alltraps
80105f8b:	e9 57 f7 ff ff       	jmp    801056e7 <alltraps>
...
80105f92:	6a 71                	push   $0x71
  jmp alltraps
80105f94:	e9 4e f7 ff ff       	jmp    801056e7 <alltraps>
...
80105f9b:	6a 72                	push   $0x72
  jmp alltraps
80105f9d:	e9 45 f7 ff ff       	jmp    801056e7 <alltraps>
...
80105fa4:	6a 73                	push   $0x73
  jmp alltraps
80105fa6:	e9 3c f7 ff ff       	jmp    801056e7 <alltraps>
...
80105fad:	6a 74                	push   $0x74
  jmp alltraps
80105faf:	e9 33 f7 ff ff       	jmp    801056e7 <alltraps>
...
80105fb6:	6a 75                	push   $0x75
  jmp alltraps
80105fb8:	e9 2a f7 ff ff       	jmp    801056e7 <alltraps>
...
80105fbf:	6a 76                	push   $0x76
  jmp alltraps
80105fc1:	e9 21 f7 ff ff       	jmp    801056e7 <alltraps>
...
80105fc8:	6a 77                	push   $0x77
  jmp alltraps
80105fca:	e9 18 f7 ff ff       	jmp    801056e7 <alltraps>
...
80105fd1:	6a 78                	push   $0x78
  jmp alltraps
80105fd3:	e9 0f f7 ff ff       	jmp    801056e7 <alltraps>
...
80105fda:	6a 79                	push   $0x79
  jmp alltraps
80105fdc:	e9 06 f7 ff ff       	jmp    801056e7 <alltraps>
...
80105fe3:	6a 7a                	push   $0x7a
  jmp alltraps
80105fe5:	e9 fd f6 ff ff       	jmp    801056e7 <alltraps>
...
80105fec:	6a 7b                	push   $0x7b
  jmp alltraps
80105fee:	e9 f4 f6 ff ff       	jmp    801056e7 <alltraps>
...
80105ff5:	6a 7c                	push   $0x7c
  jmp alltraps
80105ff7:	e9 eb f6 ff ff       	jmp    801056e7 <alltraps>
...
80105ffe:	6a 7d                	push   $0x7d
  jmp alltraps
80106000:	e9 e2 f6 ff ff       	jmp    801056e7 <alltraps>
...
80106007:	6a 7e                	push   $0x7e
  jmp alltraps
80106009:	e9 d9 f6 ff ff       	jmp    801056e7 <alltraps>
...
80106010:	6a 7f                	push   $0x7f
  jmp alltraps
80106012:	e9 d0 f6 ff ff       	jmp    801056e7 <alltraps>
...
80106019:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010601e:	e9 c4 f6 ff ff       	jmp    801056e7 <alltraps>
...
80106025:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010602a:	e9 b8 f6 ff ff       	jmp    801056e7 <alltraps>
...
80106031:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106036:	e9 ac f6 ff ff       	jmp    801056e7 <alltraps>
...
8010603d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106042:	e9 a0 f6 ff ff       	jmp    801056e7 <alltraps>
...
80106049:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010604e:	e9 94 f6 ff ff       	jmp    801056e7 <alltraps>
...
80106055:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010605a:	e9 88 f6 ff ff       	jmp    801056e7 <alltraps>
...
80106061:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106066:	e9 7c f6 ff ff       	jmp    801056e7 <alltraps>
...
8010606d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106072:	e9 70 f6 ff ff       	jmp    801056e7 <alltraps>
...
80106079:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010607e:	e9 64 f6 ff ff       	jmp    801056e7 <alltraps>
...
80106085:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010608a:	e9 58 f6 ff ff       	jmp    801056e7 <alltraps>
...
80106091:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106096:	e9 4c f6 ff ff       	jmp    801056e7 <alltraps>
...
8010609d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801060a2:	e9 40 f6 ff ff       	jmp    801056e7 <alltraps>
...
801060a9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801060ae:	e9 34 f6 ff ff       	jmp    801056e7 <alltraps>
...
801060b5:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801060ba:	e9 28 f6 ff ff       	jmp    801056e7 <alltraps>
...
801060c1:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801060c6:	e9 1c f6 ff ff       	jmp    801056e7 <alltraps>
...
801060cd:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801060d2:	e9 10 f6 ff ff       	jmp    801056e7 <alltraps>
...
801060d9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801060de:	e9 04 f6 ff ff       	jmp    801056e7 <alltraps>
...
801060e5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801060ea:	e9 f8 f5 ff ff       	jmp    801056e7 <alltraps>
...
801060f1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801060f6:	e9 ec f5 ff ff       	jmp    801056e7 <alltraps>
...
801060fd:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106102:	e9 e0 f5 ff ff       	jmp    801056e7 <alltraps>
...
80106109:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010610e:	e9 d4 f5 ff ff       	jmp    801056e7 <alltraps>
...
80106115:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010611a:	e9 c8 f5 ff ff       	jmp    801056e7 <alltraps>
...
80106121:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106126:	e9 bc f5 ff ff       	jmp    801056e7 <alltraps>
...
8010612d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106132:	e9 b0 f5 ff ff       	jmp    801056e7 <alltraps>
...
80106139:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010613e:	e9 a4 f5 ff ff       	jmp    801056e7 <alltraps>
...
80106145:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010614a:	e9 98 f5 ff ff       	jmp    801056e7 <alltraps>
...
80106151:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106156:	e9 8c f5 ff ff       	jmp    801056e7 <alltraps>
...
8010615d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106162:	e9 80 f5 ff ff       	jmp    801056e7 <alltraps>
...
80106169:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010616e:	e9 74 f5 ff ff       	jmp    801056e7 <alltraps>
...
80106175:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010617a:	e9 68 f5 ff ff       	jmp    801056e7 <alltraps>
...
80106181:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106186:	e9 5c f5 ff ff       	jmp    801056e7 <alltraps>
...
8010618d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106192:	e9 50 f5 ff ff       	jmp    801056e7 <alltraps>
...
80106199:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010619e:	e9 44 f5 ff ff       	jmp    801056e7 <alltraps>
...
801061a5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801061aa:	e9 38 f5 ff ff       	jmp    801056e7 <alltraps>
...
801061b1:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801061b6:	e9 2c f5 ff ff       	jmp    801056e7 <alltraps>
...
801061bd:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801061c2:	e9 20 f5 ff ff       	jmp    801056e7 <alltraps>
...
801061c9:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801061ce:	e9 14 f5 ff ff       	jmp    801056e7 <alltraps>
...
801061d5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801061da:	e9 08 f5 ff ff       	jmp    801056e7 <alltraps>
...
801061e1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801061e6:	e9 fc f4 ff ff       	jmp    801056e7 <alltraps>
...
801061ed:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801061f2:	e9 f0 f4 ff ff       	jmp    801056e7 <alltraps>
...
801061f9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801061fe:	e9 e4 f4 ff ff       	jmp    801056e7 <alltraps>
...
80106205:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010620a:	e9 d8 f4 ff ff       	jmp    801056e7 <alltraps>
...
80106211:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106216:	e9 cc f4 ff ff       	jmp    801056e7 <alltraps>
...
8010621d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106222:	e9 c0 f4 ff ff       	jmp    801056e7 <alltraps>
...
80106229:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010622e:	e9 b4 f4 ff ff       	jmp    801056e7 <alltraps>
...
80106235:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010623a:	e9 a8 f4 ff ff       	jmp    801056e7 <alltraps>
...
80106241:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106246:	e9 9c f4 ff ff       	jmp    801056e7 <alltraps>
...
8010624d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106252:	e9 90 f4 ff ff       	jmp    801056e7 <alltraps>
...
80106259:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010625e:	e9 84 f4 ff ff       	jmp    801056e7 <alltraps>
...
80106265:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010626a:	e9 78 f4 ff ff       	jmp    801056e7 <alltraps>
...
80106271:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106276:	e9 6c f4 ff ff       	jmp    801056e7 <alltraps>
...
8010627d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106282:	e9 60 f4 ff ff       	jmp    801056e7 <alltraps>
...
80106289:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010628e:	e9 54 f4 ff ff       	jmp    801056e7 <alltraps>
...
80106295:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010629a:	e9 48 f4 ff ff       	jmp    801056e7 <alltraps>
...
801062a1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801062a6:	e9 3c f4 ff ff       	jmp    801056e7 <alltraps>
...
801062ad:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801062b2:	e9 30 f4 ff ff       	jmp    801056e7 <alltraps>
...
801062b9:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801062be:	e9 24 f4 ff ff       	jmp    801056e7 <alltraps>
...
801062c5:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801062ca:	e9 18 f4 ff ff       	jmp    801056e7 <alltraps>
...
801062d1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801062d6:	e9 0c f4 ff ff       	jmp    801056e7 <alltraps>
...
801062dd:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801062e2:	e9 00 f4 ff ff       	jmp    801056e7 <alltraps>
...
801062e9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801062ee:	e9 f4 f3 ff ff       	jmp    801056e7 <alltraps>
...
801062f5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801062fa:	e9 e8 f3 ff ff       	jmp    801056e7 <alltraps>
...
80106301:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106306:	e9 dc f3 ff ff       	jmp    801056e7 <alltraps>
...
8010630d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106312:	e9 d0 f3 ff ff       	jmp    801056e7 <alltraps>
...
80106319:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010631e:	e9 c4 f3 ff ff       	jmp    801056e7 <alltraps>
...
80106325:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010632a:	e9 b8 f3 ff ff       	jmp    801056e7 <alltraps>
...
80106331:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106336:	e9 ac f3 ff ff       	jmp    801056e7 <alltraps>
...
8010633d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106342:	e9 a0 f3 ff ff       	jmp    801056e7 <alltraps>
...
80106349:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010634e:	e9 94 f3 ff ff       	jmp    801056e7 <alltraps>
...
80106355:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010635a:	e9 88 f3 ff ff       	jmp    801056e7 <alltraps>
...
80106361:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106366:	e9 7c f3 ff ff       	jmp    801056e7 <alltraps>
...
8010636d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106372:	e9 70 f3 ff ff       	jmp    801056e7 <alltraps>
...
80106379:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010637e:	e9 64 f3 ff ff       	jmp    801056e7 <alltraps>
...
80106385:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010638a:	e9 58 f3 ff ff       	jmp    801056e7 <alltraps>
...
80106391:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106396:	e9 4c f3 ff ff       	jmp    801056e7 <alltraps>
...
8010639d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801063a2:	e9 40 f3 ff ff       	jmp    801056e7 <alltraps>
...
801063a9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801063ae:	e9 34 f3 ff ff       	jmp    801056e7 <alltraps>
...
801063b5:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801063ba:	e9 28 f3 ff ff       	jmp    801056e7 <alltraps>
...
801063c1:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801063c6:	e9 1c f3 ff ff       	jmp    801056e7 <alltraps>
...
801063cd:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801063d2:	e9 10 f3 ff ff       	jmp    801056e7 <alltraps>
...
801063d9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801063de:	e9 04 f3 ff ff       	jmp    801056e7 <alltraps>
...
801063e5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801063ea:	e9 f8 f2 ff ff       	jmp    801056e7 <alltraps>
...
801063f1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801063f6:	e9 ec f2 ff ff       	jmp    801056e7 <alltraps>
...
801063fd:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106402:	e9 e0 f2 ff ff       	jmp    801056e7 <alltraps>
...
80106409:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010640e:	e9 d4 f2 ff ff       	jmp    801056e7 <alltraps>
...
80106415:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010641a:	e9 c8 f2 ff ff       	jmp    801056e7 <alltraps>
...
80106421:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106426:	e9 bc f2 ff ff       	jmp    801056e7 <alltraps>
...
8010642d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106432:	e9 b0 f2 ff ff       	jmp    801056e7 <alltraps>
...
80106439:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010643e:	e9 a4 f2 ff ff       	jmp    801056e7 <alltraps>
...
80106445:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010644a:	e9 98 f2 ff ff       	jmp    801056e7 <alltraps>
...
80106451:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106456:	e9 8c f2 ff ff       	jmp    801056e7 <alltraps>
...
8010645d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106462:	e9 80 f2 ff ff       	jmp    801056e7 <alltraps>
...
80106469:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010646e:	e9 74 f2 ff ff       	jmp    801056e7 <alltraps>
...
80106475:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010647a:	e9 68 f2 ff ff       	jmp    801056e7 <alltraps>
...
80106481:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106486:	e9 5c f2 ff ff       	jmp    801056e7 <alltraps>
...
80106499:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010649e:	e9 44 f2 ff ff       	jmp    801056e7 <alltraps>
...
801064a5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801064aa:	e9 38 f2 ff ff       	jmp    801056e7 <alltraps>
...
801064bd:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801064c2:	e9 20 f2 ff ff       	jmp    801056e7 <alltraps>
...
801064c9:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801064ce:	e9 14 f2 ff ff       	jmp    801056e7 <alltraps>
...
801064d5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801064da:	e9 08 f2 ff ff       	jmp    801056e7 <alltraps>
...
801064e1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801064e6:	e9 fc f1 ff ff       	jmp    801056e7 <alltraps>
...
801064f9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801064fe:	e9 e4 f1 ff ff       	jmp    801056e7 <alltraps>
...
80106505:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010650a:	e9 d8 f1 ff ff       	jmp    801056e7 <alltraps>
...
80106511:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106516:	e9 cc f1 ff ff       	jmp    801056e7 <alltraps>
...
8010651d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106522:	e9 c0 f1 ff ff       	jmp    801056e7 <alltraps>
...
80106529:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010652e:	e9 b4 f1 ff ff       	jmp    801056e7 <alltraps>
...
80106535:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010653a:	e9 a8 f1 ff ff       	jmp    801056e7 <alltraps>
...
80106541:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106546:	e9 9c f1 ff ff       	jmp    801056e7 <alltraps>
...
8010654d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106552:	e9 90 f1 ff ff       	jmp    801056e7 <alltraps>
...
80106559:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010655e:	e9 84 f1 ff ff       	jmp    801056e7 <alltraps>
...
80106565:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010656a:	e9 78 f1 ff ff       	jmp    801056e7 <alltraps>
...
80106571:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106576:	e9 6c f1 ff ff       	jmp    801056e7 <alltraps>
...
8010657d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106582:	e9 60 f1 ff ff       	jmp    801056e7 <alltraps>
...
80106589:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010658e:	e9 54 f1 ff ff       	jmp    801056e7 <alltraps>
...
80106595:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010659a:	e9 48 f1 ff ff       	jmp    801056e7 <alltraps>
...
801065a1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801065a6:	e9 3c f1 ff ff       	jmp    801056e7 <alltraps>
...
801065ad:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801065b2:	e9 30 f1 ff ff       	jmp    801056e7 <alltraps>
...
801065b9:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801065be:	e9 24 f1 ff ff       	jmp    801056e7 <alltraps>
...
801065c5:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801065ca:	e9 18 f1 ff ff       	jmp    801056e7 <alltraps>
...
801065d1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801065d6:	e9 0c f1 ff ff       	jmp    801056e7 <alltraps>
...
801065dd:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801065e2:	e9 00 f1 ff ff       	jmp    801056e7 <alltraps>
...
801065e9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801065ee:	e9 f4 f0 ff ff       	jmp    801056e7 <alltraps>
...
801065f5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801065fa:	e9 e8 f0 ff ff       	jmp    801056e7 <alltraps>
...
80106601:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106606:	e9 dc f0 ff ff       	jmp    801056e7 <alltraps>
...
8010660d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106612:	e9 d0 f0 ff ff       	jmp    801056e7 <alltraps>
...
801067c2:	68 e6 71 10 80       	push   $0x801071e6
...
801067d3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
801067d6:	e8 b5 cf ff ff       	call   80103790 <cpuid>
...
801068d0:	a1 a4 57 11 80       	mov    0x801157a4,%eax
{
...
80106914:	0f 84 c4 00 00 00    	je     801069de <switchuvm+0xee>
  pushcli();
8010691a:	e8 a1 d9 ff ff       	call   801042c0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010691f:	e8 ec cd ff ff       	call   80103710 <mycpu>
80106924:	89 c3                	mov    %eax,%ebx
80106926:	e8 e5 cd ff ff       	call   80103710 <mycpu>
8010692b:	89 c7                	mov    %eax,%edi
8010692d:	e8 de cd ff ff       	call   80103710 <mycpu>
80106932:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106935:	83 c7 08             	add    $0x8,%edi
80106938:	e8 d3 cd ff ff       	call   80103710 <mycpu>
...
80106a2f:	e8 6c da ff ff       	call   801044a0 <memset>
...
80106a60:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106a61:	e9 ea da ff ff       	jmp    80104550 <memmove>
    panic("inituvm: more than a page");
80106a66:	83 ec 0c             	sub    $0xc,%esp
80106a69:	68 91 78 10 80       	push   $0x80107891
...
80106b4e:	78 7b                	js     80106bcb <allocuvm+0x8b>
  if(newsz < oldsz)
80106b50:	3b 7d 0c             	cmp    0xc(%ebp),%edi
    return oldsz;
80106b53:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(newsz < oldsz)
80106b56:	72 75                	jb     80106bcd <allocuvm+0x8d>
  a = PGROUNDUP(oldsz);
80106b58:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
80106b5e:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a < newsz; a += PGSIZE){
80106b64:	39 df                	cmp    %ebx,%edi
80106b66:	77 43                	ja     80106bab <allocuvm+0x6b>
80106b68:	eb 6e                	jmp    80106bd8 <allocuvm+0x98>
...
80106b7b:	e8 20 d9 ff ff       	call   801044a0 <memset>
...
80106b95:	e8 06 fb ff ff       	call   801066a0 <mappages>
80106b9a:	83 c4 10             	add    $0x10,%esp
80106b9d:	85 c0                	test   %eax,%eax
80106b9f:	78 47                	js     80106be8 <allocuvm+0xa8>
  for(; a < newsz; a += PGSIZE){
80106ba1:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106ba7:	39 df                	cmp    %ebx,%edi
80106ba9:	76 2d                	jbe    80106bd8 <allocuvm+0x98>
    mem = kalloc();
...
80106bb2:	89 c6                	mov    %eax,%esi
    if(mem == 0){
80106bb4:	75 ba                	jne    80106b70 <allocuvm+0x30>
      cprintf("allocuvm out of memory\n");
80106bb6:	83 ec 0c             	sub    $0xc,%esp
80106bb9:	68 c9 78 10 80       	push   $0x801078c9
80106bbe:	e8 9d 9a ff ff       	call   80100660 <cprintf>
  if(newsz >= oldsz)
80106bc3:	83 c4 10             	add    $0x10,%esp
80106bc6:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106bc9:	77 4f                	ja     80106c1a <allocuvm+0xda>
      return 0;
...
80106beb:	68 e1 78 10 80       	push   $0x801078e1
80106bf0:	e8 6b 9a ff ff       	call   80100660 <cprintf>
  if(newsz >= oldsz)
80106bf5:	83 c4 10             	add    $0x10,%esp
80106bf8:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106bfb:	76 0d                	jbe    80106c0a <allocuvm+0xca>
80106bfd:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106c00:	8b 45 08             	mov    0x8(%ebp),%eax
80106c03:	89 fa                	mov    %edi,%edx
80106c05:	e8 26 fb ff ff       	call   80106730 <deallocuvm.part.0>
      kfree(mem);
80106c0a:	83 ec 0c             	sub    $0xc,%esp
80106c0d:	56                   	push   %esi
80106c0e:	e8 cd b6 ff ff       	call   801022e0 <kfree>
      return 0;
80106c13:	83 c4 10             	add    $0x10,%esp
80106c16:	31 c0                	xor    %eax,%eax
80106c18:	eb b3                	jmp    80106bcd <allocuvm+0x8d>
80106c1a:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106c1d:	8b 45 08             	mov    0x8(%ebp),%eax
80106c20:	89 fa                	mov    %edi,%edx
80106c22:	e8 09 fb ff ff       	call   80106730 <deallocuvm.part.0>
      return 0;
80106c27:	31 c0                	xor    %eax,%eax
80106c29:	eb a2                	jmp    80106bcd <allocuvm+0x8d>
80106c2b:	90                   	nop
...
80106c40:	5d                   	pop    %ebp
80106c41:	e9 ea fa ff ff       	jmp    80106730 <deallocuvm.part.0>
...
80106c79:	e8 b2 fa ff ff       	call   80106730 <deallocuvm.part.0>
...
80106cc3:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106cc4:	e9 17 b6 ff ff       	jmp    801022e0 <kfree>
    panic("freevm: no pgdir");
...
80106ce5:	e8 a6 b7 ff ff       	call   80102490 <kalloc>
...
80106d00:	e8 9b d7 ff ff       	call   801044a0 <memset>
...
80106d1b:	e8 80 f9 ff ff       	call   801066a0 <mappages>
...
80106d8e:	e8 8d f8 ff ff       	call   80106620 <walkpgdir>
  if(pte == 0)
...
80106df0:	e8 5b d7 ff ff       	call   80104550 <memmove>
...
80106e0b:	e8 90 f8 ff ff       	call   801066a0 <mappages>
...
80106e29:	e8 f2 f7 ff ff       	call   80106620 <walkpgdir>
...
80106e45:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80106e48:	e8 43 b6 ff ff       	call   80102490 <kalloc>
...
80106e7c:	e8 5f b4 ff ff       	call   801022e0 <kfree>
      goto bad;
...
80106e8e:	e8 dd 94 ff ff       	call   80100370 <panic>
      panic("copyuvm: pte should exist");
80106e93:	83 ec 0c             	sub    $0xc,%esp
80106e96:	68 18 79 10 80       	push   $0x80107918
80106e9b:	e8 d0 94 ff ff       	call   80100370 <panic>
...
80106eae:	e8 6d f7 ff ff       	call   80106620 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
80106f1f:	e8 2c d6 ff ff       	call   80104550 <memmove>
    len -= n;
    buf += n;
